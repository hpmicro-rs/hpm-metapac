...
impl Ppor {
    ...
    #[inline(always)]
    pub const fn reset_hot(self) -> crate::common::Reg<regs::ResetHot, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize) as _) }
    }
    #[doc = "reset type attribute."]
    #[inline(always)]
    pub const fn reset_cold(self) -> crate::common::Reg<regs::ResetCold, crate::common::RW> {
...
pub mod regs {
    ...
    impl Default for ResetCold {
        #[inline(always)]
        fn default() -> ResetCold {
            ResetCold(0)
        }
    }
    impl core::fmt::Debug for ResetCold {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("ResetCold")
                .field("flag", &self.flag())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for ResetCold {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "ResetCold {{ flag: {=u32:?} }}", self.flag())
        }
    }
    #[doc = "reset source enable."]
    #[repr(transparent)]
    ...
    impl defmt::Format for ResetHold {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "ResetHold {{ status: {=u32:?} }}", self.status())
        }
    }
    #[doc = "reset type triggered by reset."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct ResetHot(pub u32);
    impl ResetHot {
    ...
    impl Default for ResetHot {
        #[inline(always)]
        fn default() -> ResetHot {
            ResetHot(0)
        }
    }
    impl core::fmt::Debug for ResetHot {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("ResetHot")
                .field("type_", &self.type_())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for ResetHot {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "ResetHot {{ type_: {=u32:?} }}", self.type_())
        }
    }
    #[doc = "reset source status."]
    #[repr(transparent)]
