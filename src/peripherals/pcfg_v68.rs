...
impl Pcfg {
    ...
    #[doc = "DCDCM mode select."]
    #[inline(always)]
    pub const fn dcdcm_mode(self) -> crate::common::Reg<regs::DcdcmMode, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x80usize) as _) }
    }
    #[doc = "DCDCM low power mode."]
    #[inline(always)]
    pub const fn dcdcm_lpmode(self) -> crate::common::Reg<regs::DcdcmLpmode, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x84usize) as _) }
    }
    #[doc = "DCDCM protection."]
    #[inline(always)]
    pub const fn dcdcm_prot(self) -> crate::common::Reg<regs::DcdcmProt, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x88usize) as _) }
    }
    #[doc = "DCDCM current estimation."]
    #[inline(always)]
    pub const fn dcdcm_current(self) -> crate::common::Reg<regs::DcdcmCurrent, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x8cusize) as _) }
    }
    #[doc = "DCDCM advance setting."]
    #[inline(always)]
    pub const fn dcdcm_advmode(self) -> crate::common::Reg<regs::DcdcmAdvmode, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x90usize) as _) }
    }
    #[doc = "DCDCM advance parameter."]
    #[inline(always)]
    pub const fn dcdcm_advparam(
        self,
    ) -> crate::common::Reg<regs::DcdcmAdvparam, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x94usize) as _) }
    }
    #[doc = "DCDCM misc parameter."]
    #[inline(always)]
    pub const fn dcdcm_misc(self) -> crate::common::Reg<regs::DcdcmMisc, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x98usize) as _) }
    }
    #[doc = "DCDCM Debug."]
    #[inline(always)]
    pub const fn dcdcm_debug(self) -> crate::common::Reg<regs::DcdcmDebug, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x9cusize) as _) }
    }
    #[doc = "DCDCM ramp time."]
    #[inline(always)]
    pub const fn dcdcm_start_time(
        self,
    ) -> crate::common::Reg<regs::DcdcmStartTime, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xa0usize) as _) }
    }
    #[doc = "DCDCM resume time."]
    #[inline(always)]
    pub const fn dcdcm_resume_time(
        self,
    ) -> crate::common::Reg<regs::DcdcmResumeTime, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xa4usize) as _) }
    }
    #[doc = "DCDCM power config."]
    #[inline(always)]
    pub const fn dcdcm_power_config(
        self,
    ) -> crate::common::Reg<regs::DcdcmPowerConfig, crate::common::RW> {
...
pub mod regs {
    ...
    impl Bandgap {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn lowpower_mode(&self) -> bool {
            let val = (self.0 >> 25usize) & 0x01;
            val != 0
        }
        #[doc = "Banggap work in low power mode, banggap function limited 0: banggap works in normal mode 1: banggap works in low power mode."]
        #[inline(always)]
        pub const fn set_lowpower_mode(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Bandgap {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Bandgap")
                ...
                .field("lowpower_mode", &self.lowpower_mode())
    ...
    impl defmt::Format for Bandgap {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Bandgap {{ vbg_p50_trim: {=u8:?}, vbg_p65_trim: {=u8:?}, vbg_1p0_trim: {=u8:?}, power_save: {=bool:?}, lowpower_mode: {=bool:?}, vbg_trimmed: {=bool:?} }}" , self . vbg_p50_trim () , self . vbg_p65_trim () , self . vbg_1p0_trim () , self . power_save () , self . lowpower_mode () , self . vbg_trimmed ())
        }
    }
    #[doc = "DCDC advance setting."]
    #[repr(transparent)]
    ...
    impl defmt::Format for DcdcAdvmode {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DcdcAdvmode {{ en_dcm: {=bool:?}, en_idle: {=bool:?}, en_skip: {=bool:?}, en_dcm_exit: {=bool:?}, en_ff_loop: {=bool:?}, en_ff_det: {=bool:?}, dc_r: {=u8:?}, dc_c: {=u8:?}, en_rcscale: {=u8:?} }}" , self . en_dcm () , self . en_idle () , self . en_skip () , self . en_dcm_exit () , self . en_ff_loop () , self . en_ff_det () , self . dc_r () , self . dc_c () , self . en_rcscale ())
        }
    }
    #[doc = "DCDC advance parameter."]
    #[repr(transparent)]
    ...
    impl DcdcProt {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn disable_power_loss(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[doc = "disable power loss protection 0: power loss protection enabled, DCDC shuts down when power loss 1: power loss protection disabled, DCDC try working after power voltage drop."]
        #[inline(always)]
        pub const fn set_disable_power_loss(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for DcdcProt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcProt")
                ...
                .field("disable_power_loss", &self.disable_power_loss())
    ...
    impl defmt::Format for DcdcProt {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DcdcProt {{ short_flag: {=bool:?}, short_current: {=bool:?}, disable_short: {=bool:?}, overvolt_flag: {=bool:?}, disable_overvoltage: {=bool:?}, power_loss_flag: {=bool:?}, disable_power_loss: {=bool:?}, overload_lp: {=bool:?}, ilimit_lp: {=bool:?} }}" , self . short_flag () , self . short_current () , self . disable_short () , self . overvolt_flag () , self . disable_overvoltage () , self . power_loss_flag () , self . disable_power_loss () , self . overload_lp () , self . ilimit_lp ())
        }
    }
    #[doc = "DCDC resume time."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmAdvmode(pub u32);
    impl DcdcmAdvmode {
        #[doc = "DCM mode 0: CCM mode 1: DCM mode."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for DcdcmAdvmode {
        #[inline(always)]
        fn default() -> DcdcmAdvmode {
            DcdcmAdvmode(0)
        }
    }
    impl core::fmt::Debug for DcdcmAdvmode {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmAdvmode")
                .field("en_dcm", &self.en_dcm())
                .field("en_idle", &self.en_idle())
                .field("en_skip", &self.en_skip())
                .field("en_dcm_exit", &self.en_dcm_exit())
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmAdvmode {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DcdcmAdvmode {{ en_dcm: {=bool:?}, en_idle: {=bool:?}, en_skip: {=bool:?}, en_dcm_exit: {=bool:?}, en_autolp: {=bool:?}, en_ff_loop: {=bool:?}, en_ff_det: {=bool:?}, dc_r: {=u8:?}, dc_c: {=u8:?}, en_rcscale: {=u8:?} }}" , self . en_dcm () , self . en_idle () , self . en_skip () , self . en_dcm_exit () , self . en_autolp () , self . en_ff_loop () , self . en_ff_det () , self . dc_r () , self . dc_c () , self . en_rcscale ())
        }
    }
    #[doc = "DCDCM advance parameter."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmAdvparam(pub u32);
    impl DcdcmAdvparam {
        #[doc = "maximum duty cycle."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for DcdcmAdvparam {
        #[inline(always)]
        fn default() -> DcdcmAdvparam {
            DcdcmAdvparam(0)
        }
    }
    impl core::fmt::Debug for DcdcmAdvparam {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmAdvparam")
                .field("max_dut", &self.max_dut())
                .field("min_dut", &self.min_dut())
                .finish()
        }
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmAdvparam {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmAdvparam {{ max_dut: {=u8:?}, min_dut: {=u8:?} }}",
                self.max_dut(),
                self.min_dut()
            )
        }
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmCurrent(pub u32);
    impl DcdcmCurrent {
        #[doc = "DCDCM current level, current level is num * 50mA."]
        #[must_use]
        #[inline(always)]
        pub const fn level(&self) -> u8 {
            let val = (self.0 >> 0usize) & 0x1f;
    ...
    impl Default for DcdcmCurrent {
        #[inline(always)]
        fn default() -> DcdcmCurrent {
            DcdcmCurrent(0)
        }
    }
    impl core::fmt::Debug for DcdcmCurrent {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmCurrent")
                .field("level", &self.level())
                .field("valid", &self.valid())
                .field("esti_en", &self.esti_en())
                .finish()
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmCurrent {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmCurrent {{ level: {=u8:?}, valid: {=bool:?}, esti_en: {=bool:?} }}",
                self.level(),
                self.valid(),
                self.esti_en()
            )
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmDebug(pub u32);
    impl DcdcmDebug {
        #[doc = "DCDCM voltage change time in 24M clock cycles, default value is 1mS."]
        #[must_use]
        #[inline(always)]
        pub const fn update_time(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0x000f_ffff;
    ...
    impl Default for DcdcmDebug {
        #[inline(always)]
        fn default() -> DcdcmDebug {
            DcdcmDebug(0)
        }
    }
    impl core::fmt::Debug for DcdcmDebug {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmDebug")
                .field("update_time", &self.update_time())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmDebug {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmDebug {{ update_time: {=u32:?} }}",
                self.update_time()
            )
        }
    }
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmLpmode(pub u32);
    impl DcdcmLpmode {
        #[doc = "DCDCM voltage in mV in standby mode, , value valid through 600-1375, , step 25mV. Hardware select voltage no less than target if not on valid steps, with maximum 1375mV. 600: 600mV 625: 625mV . . . 1375:1375mV."]
        #[must_use]
        #[inline(always)]
        pub const fn stby_volt(&self) -> u16 {
            let val = (self.0 >> 0usize) & 0x0fff;
    ...
    impl Default for DcdcmLpmode {
        #[inline(always)]
        fn default() -> DcdcmLpmode {
            DcdcmLpmode(0)
        }
    }
    impl core::fmt::Debug for DcdcmLpmode {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmLpmode")
                .field("stby_volt", &self.stby_volt())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmLpmode {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "DcdcmLpmode {{ stby_volt: {=u16:?} }}", self.stby_volt())
        }
    }
    #[doc = "DCDCM misc parameter."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmMisc(pub u32);
    impl DcdcmMisc {
        #[doc = "enable stepping in voltage change 0: stepping disabled, 1: steping enabled."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "clock selection 0: select DCDCM internal oscillator 1: select RC24M oscillator."]
        #[must_use]
        #[inline(always)]
        pub const fn clk_sel(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
    ...
    impl Default for DcdcmMisc {
        #[inline(always)]
        fn default() -> DcdcmMisc {
            DcdcmMisc(0)
        }
    }
    impl core::fmt::Debug for DcdcmMisc {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmMisc")
                .field("en_step", &self.en_step())
                .field("clk_sel", &self.clk_sel())
                .field("delay", &self.delay())
                .field("ol_hyst", &self.ol_hyst())
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmMisc {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DcdcmMisc {{ en_step: {=bool:?}, clk_sel: {=bool:?}, delay: {=bool:?}, ol_hyst: {=bool:?}, ol_thre: {=u8:?}, dc_ff: {=u8:?}, rc_scale: {=bool:?}, hyst_thrs: {=bool:?}, hyst_sign: {=bool:?}, en_hyst: {=bool:?} }}" , self . en_step () , self . clk_sel () , self . delay () , self . ol_hyst () , self . ol_thre () , self . dc_ff () , self . rc_scale () , self . hyst_thrs () , self . hyst_sign () , self . en_hyst ())
        }
    }
    #[doc = "DCDCM mode select."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmMode(pub u32);
    impl DcdcmMode {
        #[doc = "DCDCM voltage in mV in normal mode, value valid through 600-1375, , step 25mV. Hardware select voltage no less than target if not on valid steps, with maximum 1375mV. 600: 600mV 625: 625mV . . . 1375:1375mV."]
        #[must_use]
        #[inline(always)]
        pub const fn volt(&self) -> u16 {
            let val = (self.0 >> 0usize) & 0x0fff;
        ...
        #[doc = "DCDCM work mode XX0: turn off 001: basic mode 011: generic mode 101: automatic mode 111: expert mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mode(&self) -> u8 {
            let val = (self.0 >> 16usize) & 0x07;
        ...
        #[doc = "Ready flag 0: DCDCM is applying new change 1: DCDCM is ready."]
        #[must_use]
        #[inline(always)]
        pub const fn ready(&self) -> bool {
            let val = (self.0 >> 28usize) & 0x01;
    ...
    impl Default for DcdcmMode {
        #[inline(always)]
        fn default() -> DcdcmMode {
            DcdcmMode(0)
        }
    }
    impl core::fmt::Debug for DcdcmMode {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmMode")
                .field("volt", &self.volt())
                .field("mode", &self.mode())
                .field("ready", &self.ready())
                .finish()
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmMode {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmMode {{ volt: {=u16:?}, mode: {=u8:?}, ready: {=bool:?} }}",
                self.volt(),
                self.mode(),
                self.ready()
            )
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmPowerConfig(pub u32);
    impl DcdcmPowerConfig {
        #[doc = "DCDCM enter standby mode, which will reduce voltage for memory content retention 0: Shutdown DCDCM 1: reduce DCDC voltage."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for DcdcmPowerConfig {
        #[inline(always)]
        fn default() -> DcdcmPowerConfig {
            DcdcmPowerConfig(0)
        }
    }
    impl core::fmt::Debug for DcdcmPowerConfig {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmPowerConfig")
                .field("retention", &self.retention())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmPowerConfig {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmPowerConfig {{ retention: {=bool:?} }}",
                self.retention()
            )
        }
    }
    ...
    impl DcdcmProt {
        ...
        #[doc = "disable output short circuit protection 0: short circuits protection enabled, DCDCM shut down if short circuit on output detected 1: short circuit protection disabled."]
        #[must_use]
        #[inline(always)]
        pub const fn disable_short(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
        ...
        #[doc = "output over voltage protection 0: protection enabled, DCDCM will shut down is output voltage is unexpected high 1: protection disabled, DCDCM continue to adjust output voltage."]
        #[must_use]
        #[inline(always)]
        pub const fn disable_overvoltage(&self) -> bool {
            let val = (self.0 >> 15usize) & 0x01;
        ...
        #[doc = "disable power loss protection 0: power loss protection enabled, DCDCM shuts down when power loss 1: power loss protection disabled, DCDCM try working after power voltage drop."]
        #[must_use]
        #[inline(always)]
        pub const fn disable_power_loss(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
    ...
    impl Default for DcdcmProt {
        #[inline(always)]
        fn default() -> DcdcmProt {
            DcdcmProt(0)
        }
    }
    impl core::fmt::Debug for DcdcmProt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmProt")
                .field("short_flag", &self.short_flag())
                .field("short_current", &self.short_current())
                .field("disable_short", &self.disable_short())
                .field("overvolt_flag", &self.overvolt_flag())
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmProt {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DcdcmProt {{ short_flag: {=bool:?}, short_current: {=bool:?}, disable_short: {=bool:?}, overvolt_flag: {=bool:?}, disable_overvoltage: {=bool:?}, power_loss_flag: {=bool:?}, disable_power_loss: {=bool:?}, overload_lp: {=bool:?}, ilimit_lp: {=bool:?} }}" , self . short_flag () , self . short_current () , self . disable_short () , self . overvolt_flag () , self . disable_overvoltage () , self . power_loss_flag () , self . disable_power_loss () , self . overload_lp () , self . ilimit_lp ())
        }
    }
    #[doc = "DCDCM resume time."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmResumeTime(pub u32);
    impl DcdcmResumeTime {
        #[doc = "Resume delay for DCDCM to recover from low power mode, in 24M clock cycles, default value is 10uS."]
        #[must_use]
        #[inline(always)]
        pub const fn resume_time(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0x000f_ffff;
    ...
    impl Default for DcdcmResumeTime {
        #[inline(always)]
        fn default() -> DcdcmResumeTime {
            DcdcmResumeTime(0)
        }
    }
    impl core::fmt::Debug for DcdcmResumeTime {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmResumeTime")
                .field("resume_time", &self.resume_time())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmResumeTime {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmResumeTime {{ resume_time: {=u32:?} }}",
                self.resume_time()
            )
        }
    }
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DcdcmStartTime(pub u32);
    impl DcdcmStartTime {
        #[doc = "Start delay for DCDCM to turn on, in 24M clock cycles, default value is 3mS."]
        #[must_use]
        #[inline(always)]
        pub const fn start_time(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0x000f_ffff;
    ...
    impl Default for DcdcmStartTime {
        #[inline(always)]
        fn default() -> DcdcmStartTime {
            DcdcmStartTime(0)
        }
    }
    impl core::fmt::Debug for DcdcmStartTime {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DcdcmStartTime")
                .field("start_time", &self.start_time())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DcdcmStartTime {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DcdcmStartTime {{ start_time: {=u32:?} }}",
                self.start_time()
            )
        }
    }
    ...
    impl ScgCtrl {
        #[doc = "control whether clock being gated during PMIC low power flow, 2 bits for each peripheral 00,01: reserved 10: clock is always off 11: clock is always on bit6-7:gpio bit8-9:ioc bit10-11: timer bit12-13:wdog bit14-15:uart bit16-17:VAD bit18-19:SRAM."]
        #[must_use]
        #[inline(always)]
