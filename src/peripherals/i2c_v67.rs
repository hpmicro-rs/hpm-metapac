...
pub mod regs {
    ...
    impl defmt::Format for Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Ctrl {{ datacnt: {=u8:?}, dir: {:?}, phase_stop: {=bool:?}, phase_data: {=bool:?}, phase_addr: {=bool:?}, phase_start: {=bool:?} }}" , self . datacnt () , self . dir () , self . phase_stop () , self . phase_data () , self . phase_addr () , self . phase_start ())
        }
    }
    #[doc = "Data Register."]
    #[repr(transparent)]
