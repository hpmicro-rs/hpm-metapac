...
impl Power {
    ...
    #[doc = "Power Setting."]
    #[inline(always)]
    pub const fn ret_wait(self) -> crate::common::Reg<regs::RetWait, crate::common::RW> {
...
impl Sysctl {
    ...
    pub const fn power(self, n: usize) -> Power {
        assert!(n < 1usize);
        unsafe { Power::from_ptr(self.ptr.wrapping_add(0x1000usize + n * 20usize) as _) }
    }
    #[doc = "no description available."]
    #[inline(always)]
    ...
    pub const fn dacclk(self, n: usize) -> crate::common::Reg<regs::Dacclk, crate::common::RW> {
        assert!(n < 2usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1c08usize + n * 4usize) as _)
        }
    }
    #[doc = "Clock senario."]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Adcclk {
        #[doc = "current mux 0: ahb0 clock N 1: ana clock."]
        #[must_use]
        #[inline(always)]
    ...
    impl Clock {
        ...
        #[doc = "current mux in clock component 0:osc0_clk0 1:pll0_clk0 2:pll0_clk1 3:pll0_clk2 4:pll1_clk0 5:pll1_clk1 6:pll1_clk2 7:pll1_clk3."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for ClockCpu {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "ClockCpu {{ div: {=u8:?}, mux: {:?}, sub0_div: {:?}, preserve: {=bool:?}, loc_busy: {=bool:?}, glb_busy: {=bool:?} }}" , self . div () , self . mux () , self . sub0_div () , self . preserve () , self . loc_busy () , self . glb_busy ())
        }
    }
    #[doc = "Reset Setting."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct RetWait(pub u32);
    impl RetWait {
        #[doc = "wait time for memory retention mode transition, default value is 15 0: 0 clock cycle 1: 1 clock cycles . . . clock cycles count on 24MHz."]
        #[must_use]
        #[inline(always)]
        pub const fn wait(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0x000f_ffff;
    ...
    impl Default for RetWait {
        #[inline(always)]
        fn default() -> RetWait {
            RetWait(0)
        }
    }
    impl core::fmt::Debug for RetWait {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("RetWait")
                .field("wait", &self.wait())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for RetWait {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "RetWait {{ wait: {=u32:?} }}", self.wait())
        }
    }
    #[doc = "retention setting while CPU0 enter stop mode, each bit represents a resource"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    ...
    impl defmt::Format for Retention {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Retention {{ soc_mem: {=bool:?}, soc_ctx: {=bool:?}, cpu0_mem: {=bool:?}, cpu0_ctx: {=bool:?}, xtal_hold: {=bool:?}, pll0_hold: {=bool:?}, pll1_hold: {=bool:?} }}" , self . soc_mem () , self . soc_ctx () , self . cpu0_mem () , self . cpu0_ctx () , self . xtal_hold () , self . pll0_hold () , self . pll1_hold ())
        }
    }
    #[doc = "Power Setting."]
    #[repr(transparent)]
    ...
    impl Status {
        ...
        #[doc = "memory info retention control signal 0: memory not enterexitretention mode 1: memory enter retention mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mem_ret_p(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "memory info retention control signal 0: memory not enterexitretention mode 1: memory enter retention mode."]
        #[inline(always)]
        pub const fn set_mem_ret_p(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "memory info retention control signal 0: memory enter retention mode 1: memory exit retention mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mem_ret_n(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "memory info retention control signal 0: memory enter retention mode 1: memory exit retention mode."]
        #[inline(always)]
        pub const fn set_mem_ret_n(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Status {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Status")
                ...
                .field("mem_ret_p", &self.mem_ret_p())
                .field("mem_ret_n", &self.mem_ret_n())
                .field("flag_wake", &self.flag_wake())
                .field("flag", &self.flag())
                .finish()
        }
    ...
    impl defmt::Format for Status {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Status {{ lf_ack: {=bool:?}, lf_disable: {=bool:?}, mem_ret_p: {=bool:?}, mem_ret_n: {=bool:?}, flag_wake: {=bool:?}, flag: {=bool:?} }}" , self . lf_ack () , self . lf_disable () , self . mem_ret_p () , self . mem_ret_n () , self . flag_wake () , self . flag ())
        }
    }
    #[doc = "no description available."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    pub enum ClockMux {
        #[doc = "24MHz"]
        CLK_24M = 0x0,
        #[doc = "Dfaults to 720MHz. Default clock source for CPU0"]
        PLL0CLK0 = 0x01,
    ...
    impl MonitorSelection {
        pub const CLK_32K: Self = Self(0x01);
        pub const CLK_RC24M: Self = Self(0x02);
        pub const CLK_XTAL24M: Self = Self(0x03);
        pub const CLK_USB0_PHY: Self = Self(0x04);
        pub const CLK_24M: Self = Self(0x14);
        pub const PLL0CLK0: Self = Self(0x15);
        pub const PLL0CLK1: Self = Self(0x16);
        pub const PLL0CLK2: Self = Self(0x17);
        pub const PLL1CLK0: Self = Self(0x18);
        pub const PLL1CLK1: Self = Self(0x19);
        pub const PLL1CLK2: Self = Self(0x1a);
        pub const PLL1CLK3: Self = Self(0x1b);
        pub const CLK_TOP_CPU0: Self = Self(0x80);
        pub const CLK_TOP_MCHTMR0: Self = Self(0x81);
        pub const CLK_TOP_CAN0: Self = Self(0x82);
        pub const CLK_TOP_CAN1: Self = Self(0x83);
        pub const CLK_TOP_CAN2: Self = Self(0x84);
        pub const CLK_TOP_CAN3: Self = Self(0x85);
        pub const CLK_TOP_LIN0: Self = Self(0x86);
        pub const CLK_TOP_LIN1: Self = Self(0x87);
        pub const CLK_TOP_LIN2: Self = Self(0x88);
        pub const CLK_TOP_LIN3: Self = Self(0x89);
        pub const CLK_TOP_GPTMR0: Self = Self(0x8a);
        pub const CLK_TOP_GPTMR1: Self = Self(0x8b);
        pub const CLK_TOP_GPTMR2: Self = Self(0x8c);
        pub const CLK_TOP_GPTMR3: Self = Self(0x8d);
        pub const CLK_TOP_I2C0: Self = Self(0x8e);
        pub const CLK_TOP_I2C1: Self = Self(0x8f);
        pub const CLK_TOP_I2C2: Self = Self(0x90);
        pub const CLK_TOP_I2C3: Self = Self(0x91);
        pub const CLK_TOP_SPI0: Self = Self(0x92);
        pub const CLK_TOP_SPI1: Self = Self(0x93);
        pub const CLK_TOP_SPI2: Self = Self(0x94);
        pub const CLK_TOP_SPI3: Self = Self(0x95);
        pub const CLK_TOP_UART0: Self = Self(0x96);
        pub const CLK_TOP_UART1: Self = Self(0x97);
        pub const CLK_TOP_UART2: Self = Self(0x98);
        pub const CLK_TOP_UART3: Self = Self(0x99);
        pub const CLK_TOP_UART4: Self = Self(0x9a);
        pub const CLK_TOP_UART5: Self = Self(0x9b);
        pub const CLK_TOP_UART6: Self = Self(0x9c);
        pub const CLK_TOP_UART7: Self = Self(0x9d);
        pub const CLK_TOP_XPI0: Self = Self(0x9e);
        pub const CLK_TOP_ANA0: Self = Self(0x9f);
        pub const CLK_TOP_ANA1: Self = Self(0xa0);
        pub const CLK_TOP_ANA2: Self = Self(0xa1);
        pub const CLK_TOP_ANA3: Self = Self(0xa2);
        pub const CLK_TOP_REF0: Self = Self(0xa3);
        pub const CLK_TOP_REF1: Self = Self(0xa4);
    }
    impl MonitorSelection {
    ...
    impl core::fmt::Debug for MonitorSelection {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                0x01 => f.write_str("CLK_32K"),
                0x02 => f.write_str("CLK_RC24M"),
                0x03 => f.write_str("CLK_XTAL24M"),
                0x04 => f.write_str("CLK_USB0_PHY"),
                0x14 => f.write_str("CLK_24M"),
                0x15 => f.write_str("PLL0CLK0"),
                0x16 => f.write_str("PLL0CLK1"),
                0x17 => f.write_str("PLL0CLK2"),
                0x18 => f.write_str("PLL1CLK0"),
                0x19 => f.write_str("PLL1CLK1"),
                0x1a => f.write_str("PLL1CLK2"),
                0x1b => f.write_str("PLL1CLK3"),
                0x80 => f.write_str("CLK_TOP_CPU0"),
                0x81 => f.write_str("CLK_TOP_MCHTMR0"),
                0x82 => f.write_str("CLK_TOP_CAN0"),
                0x83 => f.write_str("CLK_TOP_CAN1"),
                0x84 => f.write_str("CLK_TOP_CAN2"),
                0x85 => f.write_str("CLK_TOP_CAN3"),
                0x86 => f.write_str("CLK_TOP_LIN0"),
                0x87 => f.write_str("CLK_TOP_LIN1"),
                0x88 => f.write_str("CLK_TOP_LIN2"),
                0x89 => f.write_str("CLK_TOP_LIN3"),
                0x8a => f.write_str("CLK_TOP_GPTMR0"),
                0x8b => f.write_str("CLK_TOP_GPTMR1"),
                0x8c => f.write_str("CLK_TOP_GPTMR2"),
                0x8d => f.write_str("CLK_TOP_GPTMR3"),
                0x8e => f.write_str("CLK_TOP_I2C0"),
                0x8f => f.write_str("CLK_TOP_I2C1"),
                0x90 => f.write_str("CLK_TOP_I2C2"),
                0x91 => f.write_str("CLK_TOP_I2C3"),
                0x92 => f.write_str("CLK_TOP_SPI0"),
                0x93 => f.write_str("CLK_TOP_SPI1"),
                0x94 => f.write_str("CLK_TOP_SPI2"),
                0x95 => f.write_str("CLK_TOP_SPI3"),
                0x96 => f.write_str("CLK_TOP_UART0"),
                0x97 => f.write_str("CLK_TOP_UART1"),
                0x98 => f.write_str("CLK_TOP_UART2"),
                0x99 => f.write_str("CLK_TOP_UART3"),
                0x9a => f.write_str("CLK_TOP_UART4"),
                0x9b => f.write_str("CLK_TOP_UART5"),
                0x9c => f.write_str("CLK_TOP_UART6"),
                0x9d => f.write_str("CLK_TOP_UART7"),
                0x9e => f.write_str("CLK_TOP_XPI0"),
                0x9f => f.write_str("CLK_TOP_ANA0"),
                0xa0 => f.write_str("CLK_TOP_ANA1"),
                0xa1 => f.write_str("CLK_TOP_ANA2"),
                0xa2 => f.write_str("CLK_TOP_ANA3"),
                0xa3 => f.write_str("CLK_TOP_REF0"),
                0xa4 => f.write_str("CLK_TOP_REF1"),
    ...
    impl defmt::Format for MonitorSelection {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                0x01 => defmt::write!(f, "CLK_32K"),
                0x02 => defmt::write!(f, "CLK_RC24M"),
                0x03 => defmt::write!(f, "CLK_XTAL24M"),
                0x04 => defmt::write!(f, "CLK_USB0_PHY"),
                0x14 => defmt::write!(f, "CLK_24M"),
                0x15 => defmt::write!(f, "PLL0CLK0"),
                0x16 => defmt::write!(f, "PLL0CLK1"),
                0x17 => defmt::write!(f, "PLL0CLK2"),
                0x18 => defmt::write!(f, "PLL1CLK0"),
                0x19 => defmt::write!(f, "PLL1CLK1"),
                0x1a => defmt::write!(f, "PLL1CLK2"),
                0x1b => defmt::write!(f, "PLL1CLK3"),
                0x80 => defmt::write!(f, "CLK_TOP_CPU0"),
                0x81 => defmt::write!(f, "CLK_TOP_MCHTMR0"),
                0x82 => defmt::write!(f, "CLK_TOP_CAN0"),
                0x83 => defmt::write!(f, "CLK_TOP_CAN1"),
                0x84 => defmt::write!(f, "CLK_TOP_CAN2"),
                0x85 => defmt::write!(f, "CLK_TOP_CAN3"),
                0x86 => defmt::write!(f, "CLK_TOP_LIN0"),
                0x87 => defmt::write!(f, "CLK_TOP_LIN1"),
                0x88 => defmt::write!(f, "CLK_TOP_LIN2"),
                0x89 => defmt::write!(f, "CLK_TOP_LIN3"),
                0x8a => defmt::write!(f, "CLK_TOP_GPTMR0"),
                0x8b => defmt::write!(f, "CLK_TOP_GPTMR1"),
                0x8c => defmt::write!(f, "CLK_TOP_GPTMR2"),
                0x8d => defmt::write!(f, "CLK_TOP_GPTMR3"),
                0x8e => defmt::write!(f, "CLK_TOP_I2C0"),
                0x8f => defmt::write!(f, "CLK_TOP_I2C1"),
                0x90 => defmt::write!(f, "CLK_TOP_I2C2"),
                0x91 => defmt::write!(f, "CLK_TOP_I2C3"),
                0x92 => defmt::write!(f, "CLK_TOP_SPI0"),
                0x93 => defmt::write!(f, "CLK_TOP_SPI1"),
                0x94 => defmt::write!(f, "CLK_TOP_SPI2"),
                0x95 => defmt::write!(f, "CLK_TOP_SPI3"),
                0x96 => defmt::write!(f, "CLK_TOP_UART0"),
                0x97 => defmt::write!(f, "CLK_TOP_UART1"),
                0x98 => defmt::write!(f, "CLK_TOP_UART2"),
                0x99 => defmt::write!(f, "CLK_TOP_UART3"),
                0x9a => defmt::write!(f, "CLK_TOP_UART4"),
                0x9b => defmt::write!(f, "CLK_TOP_UART5"),
                0x9c => defmt::write!(f, "CLK_TOP_UART6"),
                0x9d => defmt::write!(f, "CLK_TOP_UART7"),
                0x9e => defmt::write!(f, "CLK_TOP_XPI0"),
                0x9f => defmt::write!(f, "CLK_TOP_ANA0"),
                0xa0 => defmt::write!(f, "CLK_TOP_ANA1"),
                0xa1 => defmt::write!(f, "CLK_TOP_ANA2"),
                0xa2 => defmt::write!(f, "CLK_TOP_ANA3"),
                0xa3 => defmt::write!(f, "CLK_TOP_REF0"),
                0xa4 => defmt::write!(f, "CLK_TOP_REF1"),
