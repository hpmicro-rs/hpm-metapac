...
pub mod regs {
    ...
    impl Pin {
        ...
        #[doc = "pin value visibility to soc gpio0, 0: visible; 1: invisible."]
        #[inline(always)]
        pub const fn set_hide_gpio0(&mut self, val: bool) {
        ...
        #[doc = "pin value visibility to cpu0 fast gpio, 0: visible; 1: invisible."]
        #[inline(always)]
        pub const fn set_hide_cpu0_fgpio(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Pin {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pin")
                ...
                .field("hide_gpio0", &self.hide_gpio0())
                .field("hide_cpu0_fgpio", &self.hide_cpu0_fgpio())
    ...
    impl defmt::Format for Pin {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Pin {{ select: {:?}, hide: {=u8:?}, hide_gpio0: {=bool:?}, hide_cpu0_fgpio: {=bool:?}, lock: {=bool:?} }}" , self . select () , self . hide () , self . hide_gpio0 () , self . hide_cpu0_fgpio () , self . lock ())
        }
    }
}
pub mod vals {
