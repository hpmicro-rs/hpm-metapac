...
pub mod regs {
    ...
    impl Retention {
        ...
        #[doc = "retention setting while CPU0 enter stop mode, each bit represents a resource bit00: soc_mem is kept on while cpu0 stop bit01: soc_ctx is kept on while cpu0 stop bit02: cpu0_mem is kept on while cpu0 stop bit03: cpu0_ctx is kept on while cpu0 stop bit04: cpu1_mem is kept on while cpu0 stop bit05: cpu1_ctx is kept on while cpu0 stop bit06: xtal_hold is kept on while cpu0 stop bit07: pll0_hold is kept on while cpu0 stop bit08: pll1_hold is kept on while cpu0 stop bit09: pll2_hold is kept on while cpu0 stop."]
        #[inline(always)]
        pub const fn set_link(&mut self, val: u16) {
    ...
    impl defmt::Format for Retention {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Retention {{ link: {=u16:?} }}", self.link())
        }
    }
    #[doc = "Power Setting."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    impl MonitorSelection {
        ...
        pub const CLK_IRC24M: Self = Self(0x01);
        ...
        pub const PLL0CLK1: Self = Self(0x0a);
        pub const PLL0CLK2: Self = Self(0x0b);
        pub const PLL1CLK0: Self = Self(0x0c);
        pub const PLL1CLK1: Self = Self(0x0d);
        pub const PLL2CLK0: Self = Self(0x0e);
        pub const PLL2CLK1: Self = Self(0x0f);
        pub const CLK_TOP_CPU0: Self = Self(0x80);
        pub const CLK_TOP_MCHTMR0: Self = Self(0x81);
        pub const CLK_TOP_MCHTMR1: Self = Self(0x82);
        pub const CLK_TOP_XPI0: Self = Self(0x83);
        pub const CLK_TOP_GPTMR0: Self = Self(0x84);
        pub const CLK_TOP_GPTMR1: Self = Self(0x85);
        pub const CLK_TOP_GPTMR2: Self = Self(0x86);
        pub const CLK_TOP_GPTMR3: Self = Self(0x87);
        pub const CLK_TOP_UART0: Self = Self(0x88);
        pub const CLK_TOP_UART1: Self = Self(0x89);
        pub const CLK_TOP_UART2: Self = Self(0x8a);
        pub const CLK_TOP_UART3: Self = Self(0x8b);
        pub const CLK_TOP_UART4: Self = Self(0x8c);
        pub const CLK_TOP_UART5: Self = Self(0x8d);
        pub const CLK_TOP_UART6: Self = Self(0x8e);
        pub const CLK_TOP_UART7: Self = Self(0x8f);
        pub const CLK_TOP_I2C0: Self = Self(0x90);
        pub const CLK_TOP_I2C1: Self = Self(0x91);
        pub const CLK_TOP_I2C2: Self = Self(0x92);
        pub const CLK_TOP_I2C3: Self = Self(0x93);
        pub const CLK_TOP_SPI0: Self = Self(0x94);
        pub const CLK_TOP_SPI1: Self = Self(0x95);
        pub const CLK_TOP_SPI2: Self = Self(0x96);
        pub const CLK_TOP_SPI3: Self = Self(0x97);
        pub const CLK_TOP_CAN0: Self = Self(0x98);
        pub const CLK_TOP_CAN1: Self = Self(0x99);
        pub const CLK_TOP_CAN2: Self = Self(0x9a);
        pub const CLK_TOP_CAN3: Self = Self(0x9b);
        pub const CLK_TOP_PTPC: Self = Self(0x9c);
        pub const CLK_TOP_ANA0: Self = Self(0x9d);
        pub const CLK_TOP_ANA1: Self = Self(0x9e);
        pub const CLK_TOP_ANA2: Self = Self(0x9f);
        pub const CLK_TOP_ANA3: Self = Self(0xa0);
        pub const CLK_TOP_ANA4: Self = Self(0xa1);
        pub const CLK_TOP_REF0: Self = Self(0xa2);
        pub const CLK_TOP_REF1: Self = Self(0xa3);
        pub const CLK_TOP_LIN0: Self = Self(0xa4);
        pub const CLK_TOP_LIN1: Self = Self(0xa5);
        pub const CLK_TOP_LIN2: Self = Self(0xa6);
        pub const CLK_TOP_LIN3: Self = Self(0xa7);
    }
    impl MonitorSelection {
    ...
    impl core::fmt::Debug for MonitorSelection {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                ...
                0x0a => f.write_str("PLL0CLK1"),
                0x0b => f.write_str("PLL0CLK2"),
                0x0c => f.write_str("PLL1CLK0"),
                0x0d => f.write_str("PLL1CLK1"),
                0x0e => f.write_str("PLL2CLK0"),
                0x0f => f.write_str("PLL2CLK1"),
                0x80 => f.write_str("CLK_TOP_CPU0"),
                0x81 => f.write_str("CLK_TOP_MCHTMR0"),
                0x82 => f.write_str("CLK_TOP_MCHTMR1"),
                0x83 => f.write_str("CLK_TOP_XPI0"),
                0x84 => f.write_str("CLK_TOP_GPTMR0"),
                0x85 => f.write_str("CLK_TOP_GPTMR1"),
                0x86 => f.write_str("CLK_TOP_GPTMR2"),
                0x87 => f.write_str("CLK_TOP_GPTMR3"),
                0x88 => f.write_str("CLK_TOP_UART0"),
                0x89 => f.write_str("CLK_TOP_UART1"),
                0x8a => f.write_str("CLK_TOP_UART2"),
                0x8b => f.write_str("CLK_TOP_UART3"),
                0x8c => f.write_str("CLK_TOP_UART4"),
                0x8d => f.write_str("CLK_TOP_UART5"),
                0x8e => f.write_str("CLK_TOP_UART6"),
                0x8f => f.write_str("CLK_TOP_UART7"),
                0x90 => f.write_str("CLK_TOP_I2C0"),
                0x91 => f.write_str("CLK_TOP_I2C1"),
                0x92 => f.write_str("CLK_TOP_I2C2"),
                0x93 => f.write_str("CLK_TOP_I2C3"),
                0x94 => f.write_str("CLK_TOP_SPI0"),
                0x95 => f.write_str("CLK_TOP_SPI1"),
                0x96 => f.write_str("CLK_TOP_SPI2"),
                0x97 => f.write_str("CLK_TOP_SPI3"),
                0x98 => f.write_str("CLK_TOP_CAN0"),
                0x99 => f.write_str("CLK_TOP_CAN1"),
                0x9a => f.write_str("CLK_TOP_CAN2"),
                0x9b => f.write_str("CLK_TOP_CAN3"),
                0x9c => f.write_str("CLK_TOP_PTPC"),
                0x9d => f.write_str("CLK_TOP_ANA0"),
                0x9e => f.write_str("CLK_TOP_ANA1"),
                0x9f => f.write_str("CLK_TOP_ANA2"),
                0xa0 => f.write_str("CLK_TOP_ANA3"),
                0xa1 => f.write_str("CLK_TOP_ANA4"),
                0xa2 => f.write_str("CLK_TOP_REF0"),
                0xa3 => f.write_str("CLK_TOP_REF1"),
                0xa4 => f.write_str("CLK_TOP_LIN0"),
                0xa5 => f.write_str("CLK_TOP_LIN1"),
                0xa6 => f.write_str("CLK_TOP_LIN2"),
                0xa7 => f.write_str("CLK_TOP_LIN3"),
    ...
    impl defmt::Format for MonitorSelection {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                ...
                0x0a => defmt::write!(f, "PLL0CLK1"),
                0x0b => defmt::write!(f, "PLL0CLK2"),
                0x0c => defmt::write!(f, "PLL1CLK0"),
                0x0d => defmt::write!(f, "PLL1CLK1"),
                0x0e => defmt::write!(f, "PLL2CLK0"),
                0x0f => defmt::write!(f, "PLL2CLK1"),
                0x80 => defmt::write!(f, "CLK_TOP_CPU0"),
                0x81 => defmt::write!(f, "CLK_TOP_MCHTMR0"),
                0x82 => defmt::write!(f, "CLK_TOP_MCHTMR1"),
                0x83 => defmt::write!(f, "CLK_TOP_XPI0"),
                0x84 => defmt::write!(f, "CLK_TOP_GPTMR0"),
                0x85 => defmt::write!(f, "CLK_TOP_GPTMR1"),
                0x86 => defmt::write!(f, "CLK_TOP_GPTMR2"),
                0x87 => defmt::write!(f, "CLK_TOP_GPTMR3"),
                0x88 => defmt::write!(f, "CLK_TOP_UART0"),
                0x89 => defmt::write!(f, "CLK_TOP_UART1"),
                0x8a => defmt::write!(f, "CLK_TOP_UART2"),
                0x8b => defmt::write!(f, "CLK_TOP_UART3"),
                0x8c => defmt::write!(f, "CLK_TOP_UART4"),
                0x8d => defmt::write!(f, "CLK_TOP_UART5"),
                0x8e => defmt::write!(f, "CLK_TOP_UART6"),
                0x8f => defmt::write!(f, "CLK_TOP_UART7"),
                0x90 => defmt::write!(f, "CLK_TOP_I2C0"),
                0x91 => defmt::write!(f, "CLK_TOP_I2C1"),
                0x92 => defmt::write!(f, "CLK_TOP_I2C2"),
                0x93 => defmt::write!(f, "CLK_TOP_I2C3"),
                0x94 => defmt::write!(f, "CLK_TOP_SPI0"),
                0x95 => defmt::write!(f, "CLK_TOP_SPI1"),
                0x96 => defmt::write!(f, "CLK_TOP_SPI2"),
                0x97 => defmt::write!(f, "CLK_TOP_SPI3"),
                0x98 => defmt::write!(f, "CLK_TOP_CAN0"),
                0x99 => defmt::write!(f, "CLK_TOP_CAN1"),
                0x9a => defmt::write!(f, "CLK_TOP_CAN2"),
                0x9b => defmt::write!(f, "CLK_TOP_CAN3"),
                0x9c => defmt::write!(f, "CLK_TOP_PTPC"),
                0x9d => defmt::write!(f, "CLK_TOP_ANA0"),
                0x9e => defmt::write!(f, "CLK_TOP_ANA1"),
                0x9f => defmt::write!(f, "CLK_TOP_ANA2"),
                0xa0 => defmt::write!(f, "CLK_TOP_ANA3"),
                0xa1 => defmt::write!(f, "CLK_TOP_ANA4"),
                0xa2 => defmt::write!(f, "CLK_TOP_REF0"),
                0xa3 => defmt::write!(f, "CLK_TOP_REF1"),
                0xa4 => defmt::write!(f, "CLK_TOP_LIN0"),
                0xa5 => defmt::write!(f, "CLK_TOP_LIN1"),
                0xa6 => defmt::write!(f, "CLK_TOP_LIN2"),
                0xa7 => defmt::write!(f, "CLK_TOP_LIN3"),
