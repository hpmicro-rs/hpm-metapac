...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_erce(&mut self, val: u16) {
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_etce(&mut self, val: u16) {
    ...
    impl defmt::Format for Endptcomplete {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Endptcomplete {{ erce: {=u16:?}, etce: {=u16:?} }}",
                self.erce(),
                self.etce()
            )
        }
...
1 Enabled An Endpoint should be enabled only after it has been configured."]
    ...
    impl defmt::Format for Endptctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Endptctrl {{ rxs: {=bool:?}, rxt: {=u8:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txt: {=u8:?}, txr: {=bool:?}, txe: {=bool:?} }}" , self . rxs () , self . rxt () , self . rxr () , self . rxe () , self . txs () , self . txt () , self . txr () , self . txe ())
        }
    }
    #[doc = "Endpoint Flush Register."]
    #[repr(transparent)]
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_ferb(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_fetb(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
...
- Endpoint #\\[N\\], N is 0-7."]
        #[inline(always)]
        pub const fn set_eprn(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
...
- Endpoint #\\[N\\], N is 0-7."]
        #[inline(always)]
        pub const fn set_eptn(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
...
- Endpoint #\\[N\\], N is 0-7."]
        #[inline(always)]
        pub const fn set_eprne(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
...
- Endpoint #\\[N\\], N is 0-7."]
        #[inline(always)]
        pub const fn set_eptne(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
    ...
    impl defmt::Format for Endptnaken {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Endptnaken {{ eprne: {=u16:?}, eptne: {=u16:?} }}",
                self.eprne(),
                self.eptne()
            )
        }
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_perb(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_petb(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_erbr(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
...
- Endpoint #N, N is in 0..7."]
        #[inline(always)]
        pub const fn set_etbr(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
...
Number Elements N In device mode the value is the current frame number of the last frame transmitted. It is not used as an index. In either mode bits 2:0 indicate the current microframe. The bit field values description below is represented as (Frame List Size) Number Elements N. 00000000000000 - (1024) 12 00000000000001 - (512) 11 00000000000010 - (256) 10 00000000000011 - (128) 9 00000000000100 - (64) 8 00000000000101 - (32) 7 00000000000110 - (16) 6 00000000000111 - (8) 5."]
    ...
    impl OtgCtrl0 {
        ...
        #[doc = "for naneng usbphy, only switch to serial mode when suspend."]
        #[inline(always)]
        pub const fn set_ser_mode_suspend_en(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_over_cur_dis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_over_cur_pol(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_power_mask(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_wakeup_int_enable(&mut self, val: bool) {
        ...
        #[doc = "default 1 for naneng usbphy."]
        #[inline(always)]
        pub const fn set_otg_utmi_reset_sw(&mut self, val: bool) {
        ...
        #[doc = "default 0 for naneng usbphy."]
        #[inline(always)]
        pub const fn set_otg_utmi_suspendm_sw(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_vbus_source_sel(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_id_wakeup_en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_vbus_wakeup_en(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_otg_wkdpdmchg_en(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for OtgCtrl0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("OtgCtrl0")
                .field("ser_mode_suspend_en", &self.ser_mode_suspend_en())
                .field("otg_over_cur_dis", &self.otg_over_cur_dis())
                .field("otg_over_cur_pol", &self.otg_over_cur_pol())
                .field("otg_power_mask", &self.otg_power_mask())
                .field("otg_wakeup_int_enable", &self.otg_wakeup_int_enable())
                .field("otg_utmi_reset_sw", &self.otg_utmi_reset_sw())
                .field("otg_utmi_suspendm_sw", &self.otg_utmi_suspendm_sw())
                .field("otg_vbus_source_sel", &self.otg_vbus_source_sel())
                .field("otg_id_wakeup_en", &self.otg_id_wakeup_en())
                .field("otg_vbus_wakeup_en", &self.otg_vbus_wakeup_en())
                .field("autoresume_en", &self.autoresume_en())
                .field("otg_wkdpdmchg_en", &self.otg_wkdpdmchg_en())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for OtgCtrl0 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "OtgCtrl0 {{ ser_mode_suspend_en: {=bool:?}, otg_over_cur_dis: {=bool:?}, otg_over_cur_pol: {=bool:?}, otg_power_mask: {=bool:?}, otg_wakeup_int_enable: {=bool:?}, otg_utmi_reset_sw: {=bool:?}, otg_utmi_suspendm_sw: {=bool:?}, otg_vbus_source_sel: {=bool:?}, otg_id_wakeup_en: {=bool:?}, otg_vbus_wakeup_en: {=bool:?}, autoresume_en: {=bool:?}, otg_wkdpdmchg_en: {=bool:?} }}" , self . ser_mode_suspend_en () , self . otg_over_cur_dis () , self . otg_over_cur_pol () , self . otg_power_mask () , self . otg_wakeup_int_enable () , self . otg_utmi_reset_sw () , self . otg_utmi_suspendm_sw () , self . otg_vbus_source_sel () , self . otg_id_wakeup_en () , self . otg_vbus_wakeup_en () , self . autoresume_en () , self . otg_wkdpdmchg_en ())
        }
    }
    #[doc = "On-The-Go Status & control Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Otgsc {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Otgsc {{ vd: {=bool:?}, vc: {=bool:?}, idpu: {=bool:?}, id: {=bool:?}, avv: {=bool:?}, asv: {=bool:?}, idis: {=bool:?}, avvis: {=bool:?}, asvis: {=bool:?}, idie: {=bool:?}, avvie: {=bool:?}, asvie: {=bool:?} }}" , self . vd () , self . vc () , self . idpu () , self . id () , self . avv () , self . asv () , self . idis () , self . avvis () , self . asvis () , self . idie () , self . avvie () , self . asvie ())
        }
    }
    #[doc = "Frame List Base Address Register."]
    #[repr(transparent)]
    ...
    impl PhyCtrl0 {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_vbus_valid_override_en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_sess_valid_override_en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_id_dig_override_en(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_vbus_valid_override(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_sess_valid_override(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_id_dig_override(&mut self, val: bool) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_gpio_id_sel_n(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize);
        }
    }
    ...
    impl core::fmt::Debug for PhyCtrl0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("PhyCtrl0")
                .field("vbus_valid_override_en", &self.vbus_valid_override_en())
                .field("sess_valid_override_en", &self.sess_valid_override_en())
                .field("id_dig_override_en", &self.id_dig_override_en())
                .field("vbus_valid_override", &self.vbus_valid_override())
                .field("sess_valid_override", &self.sess_valid_override())
                .field("id_dig_override", &self.id_dig_override())
                .field("gpio_id_sel_n", &self.gpio_id_sel_n())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for PhyCtrl0 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PhyCtrl0 {{ vbus_valid_override_en: {=bool:?}, sess_valid_override_en: {=bool:?}, id_dig_override_en: {=bool:?}, vbus_valid_override: {=bool:?}, sess_valid_override: {=bool:?}, id_dig_override: {=bool:?}, gpio_id_sel_n: {=bool:?} }}" , self . vbus_valid_override_en () , self . sess_valid_override_en () , self . id_dig_override_en () , self . vbus_valid_override () , self . sess_valid_override () , self . id_dig_override () , self . gpio_id_sel_n ())
        }
    }
    #[doc = "No description available."]
    #[repr(transparent)]
    ...
    impl PhyCtrl1 {
        ...
        #[doc = "OTG suspend, not utmi_suspendm."]
        #[inline(always)]
        pub const fn set_utmi_otg_suspendm(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_utmi_cfg_rst_n(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for PhyCtrl1 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("PhyCtrl1")
                .field("utmi_otg_suspendm", &self.utmi_otg_suspendm())
                .field("utmi_cfg_rst_n", &self.utmi_cfg_rst_n())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for PhyCtrl1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "PhyCtrl1 {{ utmi_otg_suspendm: {=bool:?}, utmi_cfg_rst_n: {=bool:?} }}",
                self.utmi_otg_suspendm(),
                self.utmi_cfg_rst_n()
            )
        }
    }
    ...
    impl PhyStatus {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_utmi_sess_valid(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_id_dig(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_host_disconnect(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "No description available."]
        #[must_use]
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_line_state(&mut self, val: u8) {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_utmi_clk_valid(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl core::fmt::Debug for PhyStatus {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("PhyStatus")
                ...
                .field("utmi_sess_valid", &self.utmi_sess_valid())
                .field("id_dig", &self.id_dig())
                .field("host_disconnect", &self.host_disconnect())
                .field("line_state", &self.line_state())
                .field("utmi_clk_valid", &self.utmi_clk_valid())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for PhyStatus {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PhyStatus {{ vbus_valid: {=bool:?}, utmi_sess_valid: {=bool:?}, id_dig: {=bool:?}, host_disconnect: {=bool:?}, line_state: {=u8:?}, utmi_clk_valid: {=bool:?} }}" , self . vbus_valid () , self . utmi_sess_valid () , self . id_dig () , self . host_disconnect () , self . line_state () , self . utmi_clk_valid ())
        }
    }
    #[doc = "Port Status & Control."]
    #[repr(transparent)]
...
1 - Select the 16-bit UTMI interface \\[30MHz\\]."]
    ...
    impl defmt::Format for Portsc1 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Portsc1 {{ ccs: {=bool:?}, csc: {=bool:?}, pe: {=bool:?}, pec: {=bool:?}, oca: {=bool:?}, occ: {=bool:?}, fpr: {=bool:?}, susp: {=bool:?}, pr: {=bool:?}, hsp: {=bool:?}, ls: {=u8:?}, pp: {=bool:?}, ptc: {=u8:?}, wkcn: {=bool:?}, wkdc: {=bool:?}, wkoc: {=bool:?}, phcd: {=bool:?}, pfsc: {=bool:?}, pspd: {=u8:?}, ptw: {=bool:?}, sts: {=bool:?} }}" , self . ccs () , self . csc () , self . pe () , self . pec () , self . oca () , self . occ () , self . fpr () , self . susp () , self . pr () , self . hsp () , self . ls () , self . pp () , self . ptc () , self . wkcn () , self . wkdc () , self . wkoc () , self . phcd () , self . pfsc () , self . pspd () , self . ptw () , self . sts ())
        }
    }
    #[doc = "System Bus Config Register."]
    #[repr(transparent)]
    ...
    impl Sbuscfg {
        ...
        #[doc = "AHBBRST AHB master interface Burst configuration These bits control AHB master transfer type sequence (or priority). NOTE: This register overrides n_BURSTSIZE register when its value is not zero. 000 - Incremental burst of unspecified length only 001 - INCR4 burst, then single transfer 010 - INCR8 burst, INCR4 burst, then single transfer 011 - INCR16 burst, INCR8 burst, INCR4 burst, then single transfer 100 - Reserved, don't use 101 - INCR4 burst, then incremental burst of unspecified length 110 - INCR8 burst, INCR4 burst, then incremental burst of unspecified length 111 - INCR16 burst, INCR8 burst, INCR4 burst, then incremental burst of unspecified length."]
        #[inline(always)]
        pub const fn set_ahbbrst(&mut self, val: u8) {
    ...
    impl TopStatus {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_wakeup_int_status(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl core::fmt::Debug for TopStatus {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("TopStatus")
                .field("wakeup_int_status", &self.wakeup_int_status())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for TopStatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "TopStatus {{ wakeup_int_status: {=bool:?} }}",
                self.wakeup_int_status()
            )
        }
    }
    #[doc = "TX FIFO Fill Tuning Register."]
...
This register adds an additional fixed offset to the schedule time estimator described above as Tff. As an approximation, the value chosen for this register should limit the number of back-off events captured in the TXSCHHEALTH to less than 10 per second in a highly utilized bus. Choosing a value that is too high for this register is not desired as it can needlessly reduce USB utilization. The time unit represented in this register is 1.267us when a device is connected in High-Speed Mode. The time unit represented in this register is 6.333us when a device is connected in Low/Full Speed Mode. Default value is '08h' for OTG controller core."]
    ...
    impl Usbcmd {
        ...
        #[doc = "Asynchronous Schedule start- Write only， host mode only。 this bit is used to notify hostcontroller to start async schedule immediately."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Asynchronous Schedule start- Write only， host mode only。 this bit is used to notify hostcontroller to start async schedule immediately."]
        #[inline(always)]
        pub const fn set_prm(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
...
This field is Read/Write only if Programmable Frame List Flag in the HCCPARAMS registers is set to one. This field specifies the size of the frame list that controls which bits in the Frame Index Register should be used for the Frame List Current index. NOTE: This field is made up from USBCMD bits 15, 3 and 2. Value Meaning 0b000 - 1024 elements (4096 bytes) Default value 0b001 - 512 elements (2048 bytes) 0b010 - 256 elements (1024 bytes) 0b011 - 128 elements (512 bytes) 0b100 - 64 elements (256 bytes) 0b101 - 32 elements (128 bytes) 0b110 - 16 elements (64 bytes) 0b111 - 8 elements (32 bytes)."]
        ...
        #[doc = "ITC Interrupt Threshold Control -Read/Write. The system software uses this field to set the maximum rate at which the host/device controller will issue interrupts. ITC contains the maximum interrupt interval measured in micro-frames. Valid values are shown below. Value Maximum Interrupt Interval 00000000 - Immediate (no threshold) 00000001 - 1 micro-frame 00000010 - 2 micro-frames 00000100 - 4 micro-frames 00001000 - 8 micro-frames 00010000 - 16 micro-frames 00100000 - 32 micro-frames 01000000 - 64 micro-frames."]
        #[inline(always)]
        pub const fn set_itc(&mut self, val: u8) {
    ...
    impl defmt::Format for Usbcmd {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Usbcmd {{ rs: {=bool:?}, rst: {=bool:?}, fs_1: {=u8:?}, pse: {=bool:?}, ase: {=bool:?}, iaa: {=bool:?}, asp: {=u8:?}, aspe: {=bool:?}, prm: {=bool:?}, sutw: {=bool:?}, atdtw: {=bool:?}, fs_2: {=bool:?}, itc: {=u8:?} }}" , self . rs () , self . rst () , self . fs_1 () , self . pse () , self . ase () , self . iaa () , self . asp () , self . aspe () , self . prm () , self . sutw () , self . atdtw () , self . fs_2 () , self . itc ())
        }
    }
    #[doc = "Interrupt Enable Register."]
    #[repr(transparent)]
...
toggles. Only used in host operation mode."]
        ...
        #[doc = "USB Host Asynchronous Interrupt – RWC. Default = 0b. This bit is set by the Host Controller when the cause of an interrupt is a completion of a USB transaction where the Transfer Descriptor (TD) has an interrupt on complete (IOC) bit set AND the TD was from the asynchronous schedule. This bit is also set by the Host when a short packet is detected and the packet is on the asynchronous schedule. A short packet is when the actual number of bytes received was less than expected. This bit is not used by the device controller and will always be zero."]
        #[inline(always)]
        pub const fn set_uai(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        ...
        #[doc = "USB Host Periodic Interrupt – RWC. Default = 0b. This bit is set by the Host Controller when the cause of an interrupt is a completion of a USB transaction where the Transfer Descriptor (TD) has an interrupt on complete (IOC) bit set and the TD was from the periodic schedule. This bit is also set by the Host Controller when a short packet is detected and the packet is on the periodic schedule. A short packet is when the actual number of bytes received was less than expected. This bit is not used by the device controller and will always be zero."]
        #[inline(always)]
        pub const fn set_upi(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize);
        }
    ...
    impl defmt::Format for Usbsts {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Usbsts {{ ui: {=bool:?}, uei: {=bool:?}, pci: {=bool:?}, fri: {=bool:?}, sei: {=bool:?}, aai: {=bool:?}, uri: {=bool:?}, sri: {=bool:?}, sli: {=bool:?}, hch: {=bool:?}, rcl: {=bool:?}, ps: {=bool:?}, as_: {=bool:?}, naki: {=bool:?}, uai: {=bool:?}, upi: {=bool:?}, ti0: {=bool:?}, ti1: {=bool:?} }}" , self . ui () , self . uei () , self . pci () , self . fri () , self . sei () , self . aai () , self . uri () , self . sri () , self . sli () , self . hch () , self . rcl () , self . ps () , self . as_ () , self . naki () , self . uai () , self . upi () , self . ti0 () , self . ti1 ())
        }
    }
}
