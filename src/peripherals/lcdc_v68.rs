...
pub mod regs {
    ...
    impl Default for CamSyncHcntBest {
        #[inline(always)]
        fn default() -> CamSyncHcntBest {
            CamSyncHcntBest(0)
        }
    }
    #[doc = "max HCNT value for CAMSYNC mode."]
    ...
    impl Default for CamSyncHcntMax {
        #[inline(always)]
        fn default() -> CamSyncHcntMax {
            CamSyncHcntMax(0)
        }
    }
    #[doc = "min HCNT value for CAMSYNC mode."]
    ...
    impl Default for CamSyncHcntMin {
        #[inline(always)]
        fn default() -> CamSyncHcntMin {
            CamSyncHcntMin(0)
        }
    }
    #[doc = "current HCNT value for CAMSYNC mode."]
    ...
    impl Default for CamSyncHcntSt {
        #[inline(always)]
        fn default() -> CamSyncHcntSt {
            CamSyncHcntSt(0)
        }
    }
    #[doc = "Clut Load Control Register."]
...
bit."]
    ...
    impl Default for CtrlBpVRange {
        #[inline(always)]
        fn default() -> CtrlBpVRange {
            CtrlBpVRange(0)
        }
    }
    #[doc = "FP_V range for CAMSYNC mode."]
    ...
    impl Default for CtrlFpVRange {
        #[inline(always)]
        fn default() -> CtrlFpVRange {
            CtrlFpVRange(0)
        }
    }
    #[doc = "PW_V range for CAMSYNC mode."]
    ...
    impl Default for CtrlPwVRange {
        #[inline(always)]
        fn default() -> CtrlPwVRange {
            CtrlPwVRange(0)
        }
    }
    #[doc = "Display Window Size Register."]
...
1001b - 32 bpp (ARGB8888), byte sequence as B,G,R,A 1011b - Y8 (pixel width must be multiples of 4), byte sequence as Y1,Y2,Y3,Y4."]
    ...
    impl Default for ShadowDoneIntEn {
        #[inline(always)]
        fn default() -> ShadowDoneIntEn {
            ShadowDoneIntEn(0)
        }
    }
    #[doc = "Shadow done status."]
    ...
    impl Default for ShadowDoneSt {
        #[inline(always)]
        fn default() -> ShadowDoneSt {
            ShadowDoneSt(0)
        }
    }
    #[doc = "Status Register."]
