...
impl Spi {
    ...
    #[inline(always)]
    pub const fn wr_trans_cnt(self) -> crate::common::Reg<regs::WrTransCnt, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Transfer count for read data."]
    #[inline(always)]
    pub const fn rd_trans_cnt(self) -> crate::common::Reg<regs::RdTransCnt, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn direct_io(self) -> crate::common::Reg<regs::DirectIo, crate::common::RW> {
    ...
    #[doc = "WCnt."]
    #[inline(always)]
    pub const fn slv_data_wcnt(self) -> crate::common::Reg<regs::SlvDataWcnt, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x68usize) as _) }
    }
    #[doc = "RCnt."]
    #[inline(always)]
    pub const fn slv_data_rcnt(self) -> crate::common::Reg<regs::SlvDataRcnt, crate::common::RW> {
...
pub mod regs {
    ...
    impl Ctrl {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn cs_en(&self) -> u8 {
            let val = (self.0 >> 24usize) & 0x0f;
            val as u8
        }
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_cs_en(&mut self, val: u8) {
    ...
    impl defmt::Format for Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Ctrl {{ spirst: {=bool:?}, rxfiforst: {=bool:?}, txfiforst: {=bool:?}, rxdmaen: {=bool:?}, txdmaen: {=bool:?}, rxthres: {=u8:?}, txthres: {=u8:?}, cs_en: {=u8:?} }}" , self . spirst () , self . rxfiforst () , self . txfiforst () , self . rxdmaen () , self . txdmaen () , self . rxthres () , self . txthres () , self . cs_en ())
        }
    }
    #[doc = "Data Register."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct DirectIo(pub u32);
    impl DirectIo {
        #[doc = "Status of the SPI CS (chip select) signal."]
        #[must_use]
        #[inline(always)]
        pub const fn cs_i(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI CS (chip select) signal."]
        #[inline(always)]
        pub const fn set_cs_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "Status of the SPI SCLK signal."]
        #[must_use]
        #[inline(always)]
        pub const fn sclk_i(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI SCLK signal."]
        #[inline(always)]
        pub const fn set_sclk_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "Status of the SPI MOSI signal."]
        #[must_use]
        #[inline(always)]
        pub const fn mosi_i(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI MOSI signal."]
        #[inline(always)]
        pub const fn set_mosi_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[doc = "Status of the SPI MISO signal."]
        #[must_use]
        #[inline(always)]
        pub const fn miso_i(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI MISO signal."]
        #[inline(always)]
        pub const fn set_miso_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[doc = "Status of the SPI Flash write protect signal."]
        #[must_use]
        #[inline(always)]
        pub const fn wp_i(&self) -> bool {
            let val = (self.0 >> 4usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI Flash write protect signal."]
        #[inline(always)]
        pub const fn set_wp_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[doc = "Status of the SPI Flash hold signal."]
        #[must_use]
        #[inline(always)]
        pub const fn hold_i(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[doc = "Status of the SPI Flash hold signal."]
        #[inline(always)]
        pub const fn set_hold_i(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "Output value for the SPI CS (chip select) signal."]
        #[must_use]
        #[inline(always)]
        pub const fn cs_o(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI CS (chip select) signal."]
        #[inline(always)]
        pub const fn set_cs_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        #[doc = "Output value for the SPI SCLK signal."]
        #[must_use]
        #[inline(always)]
        pub const fn sclk_o(&self) -> bool {
            let val = (self.0 >> 9usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI SCLK signal."]
        #[inline(always)]
        pub const fn set_sclk_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        #[doc = "Output value for the SPI MOSI signal."]
        #[must_use]
        #[inline(always)]
        pub const fn mosi_o(&self) -> bool {
            let val = (self.0 >> 10usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI MOSI signal."]
        #[inline(always)]
        pub const fn set_mosi_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
        #[doc = "Output value for the SPI MISO signal."]
        #[must_use]
        #[inline(always)]
        pub const fn miso_o(&self) -> bool {
            let val = (self.0 >> 11usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI MISO signal."]
        #[inline(always)]
        pub const fn set_miso_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize);
        }
        #[doc = "Output value for the SPI Flash write protect signal."]
        #[must_use]
        #[inline(always)]
        pub const fn wp_o(&self) -> bool {
            let val = (self.0 >> 12usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI Flash write protect signal."]
        #[inline(always)]
        pub const fn set_wp_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        #[doc = "Output value for the SPI Flash hold signal."]
        #[must_use]
        #[inline(always)]
        pub const fn hold_o(&self) -> bool {
            let val = (self.0 >> 13usize) & 0x01;
            val != 0
        }
        #[doc = "Output value for the SPI Flash hold signal."]
        #[inline(always)]
        pub const fn set_hold_o(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[doc = "Output enable for SPI CS (chip select) signal."]
        #[must_use]
        #[inline(always)]
        pub const fn cs_oe(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable for SPI CS (chip select) signal."]
        #[inline(always)]
        pub const fn set_cs_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "Output enable for the SPI SCLK signal."]
        #[must_use]
        #[inline(always)]
        pub const fn sclk_oe(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable for the SPI SCLK signal."]
        #[inline(always)]
        pub const fn set_sclk_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "Output enable for the SPI MOSI signal."]
        #[must_use]
        #[inline(always)]
        pub const fn mosi_oe(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable for the SPI MOSI signal."]
        #[inline(always)]
        pub const fn set_mosi_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        #[doc = "Output enable fo the SPI MISO signal."]
        #[must_use]
        #[inline(always)]
        pub const fn miso_oe(&self) -> bool {
            let val = (self.0 >> 19usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable fo the SPI MISO signal."]
        #[inline(always)]
        pub const fn set_miso_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize);
        }
        #[doc = "Output enable for the SPI Flash write protect signal."]
        #[must_use]
        #[inline(always)]
        pub const fn wp_oe(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable for the SPI Flash write protect signal."]
        #[inline(always)]
        pub const fn set_wp_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "Output enable for the SPI Flash hold signal."]
        #[must_use]
        #[inline(always)]
        pub const fn hold_oe(&self) -> bool {
            let val = (self.0 >> 21usize) & 0x01;
            val != 0
        }
        #[doc = "Output enable for the SPI Flash hold signal."]
        #[inline(always)]
        pub const fn set_hold_oe(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[doc = "Enable Direct IO 0x0: Disable 0x1: Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn directioen(&self) -> bool {
            let val = (self.0 >> 24usize) & 0x01;
            val != 0
        }
        #[doc = "Enable Direct IO 0x0: Disable 0x1: Enable."]
        #[inline(always)]
        pub const fn set_directioen(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for DirectIo {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("DirectIo")
                .field("cs_i", &self.cs_i())
                .field("sclk_i", &self.sclk_i())
                .field("mosi_i", &self.mosi_i())
                .field("miso_i", &self.miso_i())
                .field("wp_i", &self.wp_i())
                .field("hold_i", &self.hold_i())
                .field("cs_o", &self.cs_o())
                .field("sclk_o", &self.sclk_o())
                .field("mosi_o", &self.mosi_o())
                .field("miso_o", &self.miso_o())
                .field("wp_o", &self.wp_o())
                .field("hold_o", &self.hold_o())
                .field("cs_oe", &self.cs_oe())
                .field("sclk_oe", &self.sclk_oe())
                .field("mosi_oe", &self.mosi_oe())
                .field("miso_oe", &self.miso_oe())
                .field("wp_oe", &self.wp_oe())
                .field("hold_oe", &self.hold_oe())
                .field("directioen", &self.directioen())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for DirectIo {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DirectIo {{ cs_i: {=bool:?}, sclk_i: {=bool:?}, mosi_i: {=bool:?}, miso_i: {=bool:?}, wp_i: {=bool:?}, hold_i: {=bool:?}, cs_o: {=bool:?}, sclk_o: {=bool:?}, mosi_o: {=bool:?}, miso_o: {=bool:?}, wp_o: {=bool:?}, hold_o: {=bool:?}, cs_oe: {=bool:?}, sclk_oe: {=bool:?}, mosi_oe: {=bool:?}, miso_oe: {=bool:?}, wp_oe: {=bool:?}, hold_oe: {=bool:?}, directioen: {=bool:?} }}" , self . cs_i () , self . sclk_i () , self . mosi_i () , self . miso_i () , self . wp_i () , self . hold_i () , self . cs_o () , self . sclk_o () , self . mosi_o () , self . miso_o () , self . wp_o () , self . hold_o () , self . cs_oe () , self . sclk_oe () , self . mosi_oe () , self . miso_oe () , self . wp_oe () , self . hold_oe () , self . directioen ())
        }
    }
    #[doc = "Interrupt Enable Register."]
    #[repr(transparent)]
    ...
    impl RdTransCnt {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rdtrancnt(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0xffff_ffff;
            val as u32
        }
        #[doc = "Transfer count for read data RdTranCnt indicates the number of units of data to be received from SPI bus and stored to the Data Register. The actual received count is (RdTranCnt+1). RdTransCnt only takes effect when TransMode is 0, 2, 3, 4, 5, 6 or 9. The size (bit-width) of a data unit is defined by the DataLen field of the Transfer Format Register. For TransMode 0, WrTranCnt must equal RdTranCnt."]
        #[inline(always)]
        pub const fn set_rdtrancnt(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    impl Default for RdTransCnt {
        #[inline(always)]
        fn default() -> RdTransCnt {
            RdTransCnt(0)
        }
    }
    impl core::fmt::Debug for RdTransCnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("RdTransCnt")
                .field("rdtrancnt", &self.rdtrancnt())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for RdTransCnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "RdTransCnt {{ rdtrancnt: {=u32:?} }}", self.rdtrancnt())
        }
    }
    #[doc = "Slave Data Count Register."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct SlvDataRcnt(pub u32);
    impl SlvDataRcnt {
        #[doc = "No description available."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for SlvDataRcnt {
        #[inline(always)]
        fn default() -> SlvDataRcnt {
            SlvDataRcnt(0)
        }
    }
    impl core::fmt::Debug for SlvDataRcnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("SlvDataRcnt")
                .field("val", &self.val())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for SlvDataRcnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "SlvDataRcnt {{ val: {=u32:?} }}", self.val())
        }
    }
    #[doc = "WCnt."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct SlvDataWcnt(pub u32);
    impl SlvDataWcnt {
        #[doc = "No description available."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for SlvDataWcnt {
        #[inline(always)]
        fn default() -> SlvDataWcnt {
            SlvDataWcnt(0)
        }
    }
    impl core::fmt::Debug for SlvDataWcnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("SlvDataWcnt")
                .field("val", &self.val())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for SlvDataWcnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "SlvDataWcnt {{ val: {=u32:?} }}", self.val())
        }
    }
    #[doc = "Slave Status Register."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct WrTransCnt(pub u32);
    impl WrTransCnt {
        #[doc = "Transfer count for write data WrTranCnt indicates the number of units of data to be transmitted to the SPI bus from the Data Register. The actual transfer count is (WrTranCnt+1). WrTranCnt only takes effect when TransMode is 0, 1, 3, 4, 5, 6 or 8. The size (bit-width) of a data unit is defined by the DataLen field of the Transfer Format Register. For TransMode 0, WrTranCnt must be equal to RdTranCnt."]
        #[must_use]
        #[inline(always)]
        pub const fn wrtrancnt(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0xffff_ffff;
            val as u32
        }
        #[doc = "Transfer count for write data WrTranCnt indicates the number of units of data to be transmitted to the SPI bus from the Data Register. The actual transfer count is (WrTranCnt+1). WrTranCnt only takes effect when TransMode is 0, 1, 3, 4, 5, 6 or 8. The size (bit-width) of a data unit is defined by the DataLen field of the Transfer Format Register. For TransMode 0, WrTranCnt must be equal to RdTranCnt."]
        #[inline(always)]
        pub const fn set_wrtrancnt(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    impl Default for WrTransCnt {
        #[inline(always)]
        fn default() -> WrTransCnt {
            WrTransCnt(0)
        }
    }
    impl core::fmt::Debug for WrTransCnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("WrTransCnt")
                .field("wrtrancnt", &self.wrtrancnt())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for WrTransCnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "WrTransCnt {{ wrtrancnt: {=u32:?} }}", self.wrtrancnt())
        }
    }
}
pub mod vals {
