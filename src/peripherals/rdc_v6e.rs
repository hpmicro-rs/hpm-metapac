...
x man / 2^exp."]
    ...
    impl IirA {
        ...
        #[doc = "IIR parameter a1 for a branch."]
        #[inline(always)]
        pub fn set_iir_a1(&mut self, val: u16) {
        ...
        #[doc = "IIR parameter a2 for a branch."]
        #[inline(always)]
        pub fn set_iir_a2(&mut self, val: u8) {
    ...
    impl IirB {
        ...
        #[doc = "IIR parameter for b branch."]
        #[inline(always)]
        pub fn set_iir_b(&mut self, val: u8) {
            self.0 = (self.0 & !(0x07 << 0usize)) | (((val as u32) & 0x07) << 0usize);
        }
        ...
        #[doc = "IIR in lowpass mode."]
        #[inline(always)]
        pub fn set_lowpass(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize);
        }
    }
    ...
    impl MaxMinPos {
        ...
        #[doc = "max min value position 0: max min value at adc input 1: max min value at IIR output."]
        #[inline(always)]
        pub fn set_max_min_pos(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
...
x man / 2^exp."]
    ...
    impl RdcCtl {
        ...
        #[doc = "every adc value can be as one accumulate value."]
        #[inline(always)]
        pub fn set_acc_fast(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "IIR enable for adc input."]
        #[inline(always)]
        pub fn set_iir_en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        #[doc = "rdc output mask."]
        #[inline(always)]
        ...
        #[doc = "rdc output mask."]
        #[inline(always)]
        pub fn set_acc_out_mask(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
    ...
    impl ThrsI {
        ...
        #[doc = "enable thrs data for accumulate."]
        #[inline(always)]
        pub fn set_thrs4acc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
