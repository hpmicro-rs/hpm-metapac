...
impl Sysctl {
    ...
    pub const fn group1(self, n: usize) -> Group1 {
        assert!(n < 4usize);
        unsafe { Group1::from_ptr(self.ptr.wrapping_add(0x0840usize + n * 16usize) as _) }
    }
    #[doc = "no description available."]
    #[inline(always)]
...
pub mod regs {
    ...
    impl core::fmt::Debug for Group1Clear {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Group1Clear")
                .field("link", &self.link())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Group1Clear {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Group1Clear {{ link: {=u32:?} }}", self.link())
        }
    }
    #[doc = "Group setting."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Group1Set {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Group1Set")
                .field("link", &self.link())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Group1Set {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Group1Set {{ link: {=u32:?} }}", self.link())
        }
    }
    #[doc = "Group setting."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Group1Toggle {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Group1Toggle")
                .field("link", &self.link())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Group1Toggle {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Group1Toggle {{ link: {=u32:?} }}", self.link())
        }
    }
    #[doc = "Group setting."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Group1Value {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Group1Value")
                .field("link", &self.link())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Group1Value {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Group1Value {{ link: {=u32:?} }}", self.link())
        }
    }
    #[doc = "Clock upper limit."]
    #[repr(transparent)]
    ...
    impl Retention {
        ...
        #[doc = "soc_mem is kept on while cpu0 stop 0: soc_mem is kept off 1: soc_mem is kept on."]
        #[inline(always)]
        pub const fn set_soc_mem(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "soc_ctx is kept on while cpu0 stop 0: soc_ctx is kept off 1: soc_ctx is kept on."]
        #[inline(always)]
        pub const fn set_soc_ctx(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ...
        #[doc = "cpu0_mem is kept on while cpu0 stop 0: cpu0_mem is kept off 1: cpu0_mem is kept on."]
        #[inline(always)]
        pub const fn set_cpu0_mem(&mut self, val: bool) {
        ...
        #[doc = "cpu0_ctx is kept on while cpu0 stop 0: cpu0_ctx is kept off 1: cpu0_ctx is kept on."]
        #[inline(always)]
        pub const fn set_cpu0_ctx(&mut self, val: bool) {
        ...
        #[doc = "cpu1_mem is kept on while cpu0 stop 0: cpu1_mem is kept off 1: cpu1_mem is kept on."]
        #[inline(always)]
        pub const fn set_cpu1_mem(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        ...
        #[doc = "cpu1_ctx is kept on while cpu0 stop 0: cpu1_ctx is kept off 1: cpu1_ctx is kept on."]
        #[inline(always)]
        pub const fn set_cpu1_ctx(&mut self, val: bool) {
        ...
        #[doc = "otn_mem is kept on while cpu0 stop 0: otn_mem is kept off 1: otn_mem is kept on."]
        #[inline(always)]
        pub const fn set_otn_mem(&mut self, val: bool) {
        ...
        #[doc = "otn_ctx is kept on while cpu0 stop 0: otn_ctx is kept off 1: otn_ctx is kept on."]
        #[inline(always)]
        pub const fn set_otn_ctx(&mut self, val: bool) {
        ...
        #[doc = "xtal_hold is kept on while cpu0 stop 0: xtal_hold is kept off 1: xtal_hold is kept on."]
        #[inline(always)]
        pub const fn set_xtal_hold(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        ...
        #[doc = "pll0_hold is kept on while cpu0 stop 0: pll0_hold is kept off 1: pll0_hold is kept on."]
        #[inline(always)]
        pub const fn set_pll0_hold(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        ...
        #[doc = "pll1_hold is kept on while cpu0 stop 0: pll1_hold is kept off 1: pll1_hold is kept on."]
        #[inline(always)]
        pub const fn set_pll1_hold(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
        ...
        #[doc = "pll2_hold is kept on while cpu0 stop 0: pll2_hold is kept off 1: pll2_hold is kept on."]
        #[inline(always)]
        pub const fn set_pll2_hold(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Retention {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Retention")
                .field("soc_mem", &self.soc_mem())
                .field("soc_ctx", &self.soc_ctx())
                .field("cpu0_mem", &self.cpu0_mem())
                .field("cpu0_ctx", &self.cpu0_ctx())
                .field("cpu1_mem", &self.cpu1_mem())
                .field("cpu1_ctx", &self.cpu1_ctx())
                .field("otn_mem", &self.otn_mem())
                .field("otn_ctx", &self.otn_ctx())
                .field("xtal_hold", &self.xtal_hold())
                .field("pll0_hold", &self.pll0_hold())
                .field("pll1_hold", &self.pll1_hold())
                .field("pll2_hold", &self.pll2_hold())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Retention {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Retention {{ soc_mem: {=bool:?}, soc_ctx: {=bool:?}, cpu0_mem: {=bool:?}, cpu0_ctx: {=bool:?}, cpu1_mem: {=bool:?}, cpu1_ctx: {=bool:?}, otn_mem: {=bool:?}, otn_ctx: {=bool:?}, xtal_hold: {=bool:?}, pll0_hold: {=bool:?}, pll1_hold: {=bool:?}, pll2_hold: {=bool:?} }}" , self . soc_mem () , self . soc_ctx () , self . cpu0_mem () , self . cpu0_ctx () , self . cpu1_mem () , self . cpu1_ctx () , self . otn_mem () , self . otn_ctx () , self . xtal_hold () , self . pll0_hold () , self . pll1_hold () , self . pll2_hold ())
        }
    }
    #[doc = "Power Setting."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    impl MonitorSelection {
        pub const CLK_32K_BATT: Self = Self(0x0);
        pub const CLK_32K_PMIC: Self = Self(0x01);
        pub const CLK_IRC24M: Self = Self(0x02);
        pub const CLK_XTAL24M: Self = Self(0x03);
        pub const CLK_USB0_PHY: Self = Self(0x04);
        pub const CLK0_OSC0: Self = Self(0x14);
        pub const CLK0_PLL0: Self = Self(0x15);
        pub const CLK1_PLL0: Self = Self(0x16);
        pub const CLK0_PLL1: Self = Self(0x17);
        pub const CLK1_PLL1: Self = Self(0x18);
        pub const CLK2_PLL1: Self = Self(0x19);
        pub const CLK0_PLL2: Self = Self(0x1a);
        pub const CLK1_PLL2: Self = Self(0x1b);
        pub const CLK_TOP_CPU0: Self = Self(0x80);
        pub const CLK_TOP_MCHTMR0: Self = Self(0x81);
        pub const CLK_TOP_CPU1: Self = Self(0x82);
        pub const CLK_TOP_MCHTMR1: Self = Self(0x83);
        pub const CLK_TOP_AXIF: Self = Self(0x84);
        pub const CLK_TOP_AXIS: Self = Self(0x85);
        pub const CLK_TOP_AXIC: Self = Self(0x86);
        pub const CLK_TOP_AXIN: Self = Self(0x87);
        pub const CLK_TOP_AHB0: Self = Self(0x88);
        pub const CLK_TOP_GPTMR0: Self = Self(0x89);
        pub const CLK_TOP_GPTMR1: Self = Self(0x8a);
        pub const CLK_TOP_GPTMR2: Self = Self(0x8b);
        pub const CLK_TOP_GPTMR3: Self = Self(0x8c);
        pub const CLK_TOP_GPTMR4: Self = Self(0x8d);
        pub const CLK_TOP_GPTMR5: Self = Self(0x8e);
        pub const CLK_TOP_GPTMR6: Self = Self(0x8f);
        pub const CLK_TOP_GPTMR7: Self = Self(0x90);
        pub const CLK_TOP_I2C0: Self = Self(0x91);
        pub const CLK_TOP_I2C1: Self = Self(0x92);
        pub const CLK_TOP_I2C2: Self = Self(0x93);
        pub const CLK_TOP_I2C3: Self = Self(0x94);
        pub const CLK_TOP_I2C4: Self = Self(0x95);
        pub const CLK_TOP_I2C5: Self = Self(0x96);
        pub const CLK_TOP_I2C6: Self = Self(0x97);
        pub const CLK_TOP_I2C7: Self = Self(0x98);
        pub const CLK_TOP_SPI0: Self = Self(0x99);
        pub const CLK_TOP_SPI1: Self = Self(0x9a);
        pub const CLK_TOP_SPI2: Self = Self(0x9b);
        pub const CLK_TOP_SPI3: Self = Self(0x9c);
        pub const CLK_TOP_SPI4: Self = Self(0x9d);
        pub const CLK_TOP_SPI5: Self = Self(0x9e);
        pub const CLK_TOP_SPI6: Self = Self(0x9f);
        pub const CLK_TOP_SPI7: Self = Self(0xa0);
        pub const CLK_TOP_UART0: Self = Self(0xa1);
        pub const CLK_TOP_UART1: Self = Self(0xa2);
        pub const CLK_TOP_UART2: Self = Self(0xa3);
        pub const CLK_TOP_UART3: Self = Self(0xa4);
        pub const CLK_TOP_UART4: Self = Self(0xa5);
        pub const CLK_TOP_UART5: Self = Self(0xa6);
        pub const CLK_TOP_UART6: Self = Self(0xa7);
        pub const CLK_TOP_UART7: Self = Self(0xa8);
        pub const CLK_TOP_UART8: Self = Self(0xa9);
        pub const CLK_TOP_UART9: Self = Self(0xaa);
        pub const CLK_TOP_UART10: Self = Self(0xab);
        pub const CLK_TOP_UART11: Self = Self(0xac);
        pub const CLK_TOP_UART12: Self = Self(0xad);
        pub const CLK_TOP_UART13: Self = Self(0xae);
        pub const CLK_TOP_UART14: Self = Self(0xaf);
        pub const CLK_TOP_UART15: Self = Self(0xb0);
        pub const CLK_TOP_CAN0: Self = Self(0xb1);
        pub const CLK_TOP_CAN1: Self = Self(0xb2);
        pub const CLK_TOP_CAN2: Self = Self(0xb3);
        pub const CLK_TOP_CAN3: Self = Self(0xb4);
        pub const CLK_TOP_CAN4: Self = Self(0xb5);
        pub const CLK_TOP_CAN5: Self = Self(0xb6);
        pub const CLK_TOP_CAN6: Self = Self(0xb7);
        pub const CLK_TOP_CAN7: Self = Self(0xb8);
        pub const CLK_TOP_XPI0: Self = Self(0xb9);
        pub const CLK_TOP_FEMC: Self = Self(0xba);
        pub const CLK_TOP_ANA0: Self = Self(0xbb);
        pub const CLK_TOP_ANA1: Self = Self(0xbc);
        pub const CLK_TOP_ANA2: Self = Self(0xbd);
        pub const CLK_TOP_ANA3: Self = Self(0xbe);
        pub const CLK_TOP_AUD0: Self = Self(0xbf);
        pub const CLK_TOP_AUD1: Self = Self(0xc0);
        pub const CLK_TOP_ETH0: Self = Self(0xc1);
        pub const CLK_TOP_PTP0: Self = Self(0xc2);
        pub const CLK_TOP_REF0: Self = Self(0xc3);
        pub const CLK_TOP_REF1: Self = Self(0xc4);
        pub const CLK_TOP_NTMR0: Self = Self(0xc5);
        pub const CLK_TOP_TSN1: Self = Self(0xc6);
        pub const CLK_TOP_TSN2: Self = Self(0xc7);
        pub const CLK_TOP_TSN3: Self = Self(0xc8);
    }
    impl MonitorSelection {
    ...
    impl core::fmt::Debug for MonitorSelection {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                0x0 => f.write_str("CLK_32K_BATT"),
                0x01 => f.write_str("CLK_32K_PMIC"),
                0x02 => f.write_str("CLK_IRC24M"),
                0x03 => f.write_str("CLK_XTAL24M"),
                0x04 => f.write_str("CLK_USB0_PHY"),
                0x14 => f.write_str("CLK0_OSC0"),
                0x15 => f.write_str("CLK0_PLL0"),
                0x16 => f.write_str("CLK1_PLL0"),
                0x17 => f.write_str("CLK0_PLL1"),
                0x18 => f.write_str("CLK1_PLL1"),
                0x19 => f.write_str("CLK2_PLL1"),
                0x1a => f.write_str("CLK0_PLL2"),
                0x1b => f.write_str("CLK1_PLL2"),
                0x80 => f.write_str("CLK_TOP_CPU0"),
                0x81 => f.write_str("CLK_TOP_MCHTMR0"),
                0x82 => f.write_str("CLK_TOP_CPU1"),
                0x83 => f.write_str("CLK_TOP_MCHTMR1"),
                0x84 => f.write_str("CLK_TOP_AXIF"),
                0x85 => f.write_str("CLK_TOP_AXIS"),
                0x86 => f.write_str("CLK_TOP_AXIC"),
                0x87 => f.write_str("CLK_TOP_AXIN"),
                0x88 => f.write_str("CLK_TOP_AHB0"),
                0x89 => f.write_str("CLK_TOP_GPTMR0"),
                0x8a => f.write_str("CLK_TOP_GPTMR1"),
                0x8b => f.write_str("CLK_TOP_GPTMR2"),
                0x8c => f.write_str("CLK_TOP_GPTMR3"),
                0x8d => f.write_str("CLK_TOP_GPTMR4"),
                0x8e => f.write_str("CLK_TOP_GPTMR5"),
                0x8f => f.write_str("CLK_TOP_GPTMR6"),
                0x90 => f.write_str("CLK_TOP_GPTMR7"),
                0x91 => f.write_str("CLK_TOP_I2C0"),
                0x92 => f.write_str("CLK_TOP_I2C1"),
                0x93 => f.write_str("CLK_TOP_I2C2"),
                0x94 => f.write_str("CLK_TOP_I2C3"),
                0x95 => f.write_str("CLK_TOP_I2C4"),
                0x96 => f.write_str("CLK_TOP_I2C5"),
                0x97 => f.write_str("CLK_TOP_I2C6"),
                0x98 => f.write_str("CLK_TOP_I2C7"),
                0x99 => f.write_str("CLK_TOP_SPI0"),
                0x9a => f.write_str("CLK_TOP_SPI1"),
                0x9b => f.write_str("CLK_TOP_SPI2"),
                0x9c => f.write_str("CLK_TOP_SPI3"),
                0x9d => f.write_str("CLK_TOP_SPI4"),
                0x9e => f.write_str("CLK_TOP_SPI5"),
                0x9f => f.write_str("CLK_TOP_SPI6"),
                0xa0 => f.write_str("CLK_TOP_SPI7"),
                0xa1 => f.write_str("CLK_TOP_UART0"),
                0xa2 => f.write_str("CLK_TOP_UART1"),
                0xa3 => f.write_str("CLK_TOP_UART2"),
                0xa4 => f.write_str("CLK_TOP_UART3"),
                0xa5 => f.write_str("CLK_TOP_UART4"),
                0xa6 => f.write_str("CLK_TOP_UART5"),
                0xa7 => f.write_str("CLK_TOP_UART6"),
                0xa8 => f.write_str("CLK_TOP_UART7"),
                0xa9 => f.write_str("CLK_TOP_UART8"),
                0xaa => f.write_str("CLK_TOP_UART9"),
                0xab => f.write_str("CLK_TOP_UART10"),
                0xac => f.write_str("CLK_TOP_UART11"),
                0xad => f.write_str("CLK_TOP_UART12"),
                0xae => f.write_str("CLK_TOP_UART13"),
                0xaf => f.write_str("CLK_TOP_UART14"),
                0xb0 => f.write_str("CLK_TOP_UART15"),
                0xb1 => f.write_str("CLK_TOP_CAN0"),
                0xb2 => f.write_str("CLK_TOP_CAN1"),
                0xb3 => f.write_str("CLK_TOP_CAN2"),
                0xb4 => f.write_str("CLK_TOP_CAN3"),
                0xb5 => f.write_str("CLK_TOP_CAN4"),
                0xb6 => f.write_str("CLK_TOP_CAN5"),
                0xb7 => f.write_str("CLK_TOP_CAN6"),
                0xb8 => f.write_str("CLK_TOP_CAN7"),
                0xb9 => f.write_str("CLK_TOP_XPI0"),
                0xba => f.write_str("CLK_TOP_FEMC"),
                0xbb => f.write_str("CLK_TOP_ANA0"),
                0xbc => f.write_str("CLK_TOP_ANA1"),
                0xbd => f.write_str("CLK_TOP_ANA2"),
                0xbe => f.write_str("CLK_TOP_ANA3"),
                0xbf => f.write_str("CLK_TOP_AUD0"),
                0xc0 => f.write_str("CLK_TOP_AUD1"),
                0xc1 => f.write_str("CLK_TOP_ETH0"),
                0xc2 => f.write_str("CLK_TOP_PTP0"),
                0xc3 => f.write_str("CLK_TOP_REF0"),
                0xc4 => f.write_str("CLK_TOP_REF1"),
                0xc5 => f.write_str("CLK_TOP_NTMR0"),
                0xc6 => f.write_str("CLK_TOP_TSN1"),
                0xc7 => f.write_str("CLK_TOP_TSN2"),
                0xc8 => f.write_str("CLK_TOP_TSN3"),
    ...
    impl defmt::Format for MonitorSelection {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                0x0 => defmt::write!(f, "CLK_32K_BATT"),
                0x01 => defmt::write!(f, "CLK_32K_PMIC"),
                0x02 => defmt::write!(f, "CLK_IRC24M"),
                0x03 => defmt::write!(f, "CLK_XTAL24M"),
                0x04 => defmt::write!(f, "CLK_USB0_PHY"),
                0x14 => defmt::write!(f, "CLK0_OSC0"),
                0x15 => defmt::write!(f, "CLK0_PLL0"),
                0x16 => defmt::write!(f, "CLK1_PLL0"),
                0x17 => defmt::write!(f, "CLK0_PLL1"),
                0x18 => defmt::write!(f, "CLK1_PLL1"),
                0x19 => defmt::write!(f, "CLK2_PLL1"),
                0x1a => defmt::write!(f, "CLK0_PLL2"),
                0x1b => defmt::write!(f, "CLK1_PLL2"),
                0x80 => defmt::write!(f, "CLK_TOP_CPU0"),
                0x81 => defmt::write!(f, "CLK_TOP_MCHTMR0"),
                0x82 => defmt::write!(f, "CLK_TOP_CPU1"),
                0x83 => defmt::write!(f, "CLK_TOP_MCHTMR1"),
                0x84 => defmt::write!(f, "CLK_TOP_AXIF"),
                0x85 => defmt::write!(f, "CLK_TOP_AXIS"),
                0x86 => defmt::write!(f, "CLK_TOP_AXIC"),
                0x87 => defmt::write!(f, "CLK_TOP_AXIN"),
                0x88 => defmt::write!(f, "CLK_TOP_AHB0"),
                0x89 => defmt::write!(f, "CLK_TOP_GPTMR0"),
                0x8a => defmt::write!(f, "CLK_TOP_GPTMR1"),
                0x8b => defmt::write!(f, "CLK_TOP_GPTMR2"),
                0x8c => defmt::write!(f, "CLK_TOP_GPTMR3"),
                0x8d => defmt::write!(f, "CLK_TOP_GPTMR4"),
                0x8e => defmt::write!(f, "CLK_TOP_GPTMR5"),
                0x8f => defmt::write!(f, "CLK_TOP_GPTMR6"),
                0x90 => defmt::write!(f, "CLK_TOP_GPTMR7"),
                0x91 => defmt::write!(f, "CLK_TOP_I2C0"),
                0x92 => defmt::write!(f, "CLK_TOP_I2C1"),
                0x93 => defmt::write!(f, "CLK_TOP_I2C2"),
                0x94 => defmt::write!(f, "CLK_TOP_I2C3"),
                0x95 => defmt::write!(f, "CLK_TOP_I2C4"),
                0x96 => defmt::write!(f, "CLK_TOP_I2C5"),
                0x97 => defmt::write!(f, "CLK_TOP_I2C6"),
                0x98 => defmt::write!(f, "CLK_TOP_I2C7"),
                0x99 => defmt::write!(f, "CLK_TOP_SPI0"),
                0x9a => defmt::write!(f, "CLK_TOP_SPI1"),
                0x9b => defmt::write!(f, "CLK_TOP_SPI2"),
                0x9c => defmt::write!(f, "CLK_TOP_SPI3"),
                0x9d => defmt::write!(f, "CLK_TOP_SPI4"),
                0x9e => defmt::write!(f, "CLK_TOP_SPI5"),
                0x9f => defmt::write!(f, "CLK_TOP_SPI6"),
                0xa0 => defmt::write!(f, "CLK_TOP_SPI7"),
                0xa1 => defmt::write!(f, "CLK_TOP_UART0"),
                0xa2 => defmt::write!(f, "CLK_TOP_UART1"),
                0xa3 => defmt::write!(f, "CLK_TOP_UART2"),
                0xa4 => defmt::write!(f, "CLK_TOP_UART3"),
                0xa5 => defmt::write!(f, "CLK_TOP_UART4"),
                0xa6 => defmt::write!(f, "CLK_TOP_UART5"),
                0xa7 => defmt::write!(f, "CLK_TOP_UART6"),
                0xa8 => defmt::write!(f, "CLK_TOP_UART7"),
                0xa9 => defmt::write!(f, "CLK_TOP_UART8"),
                0xaa => defmt::write!(f, "CLK_TOP_UART9"),
                0xab => defmt::write!(f, "CLK_TOP_UART10"),
                0xac => defmt::write!(f, "CLK_TOP_UART11"),
                0xad => defmt::write!(f, "CLK_TOP_UART12"),
                0xae => defmt::write!(f, "CLK_TOP_UART13"),
                0xaf => defmt::write!(f, "CLK_TOP_UART14"),
                0xb0 => defmt::write!(f, "CLK_TOP_UART15"),
                0xb1 => defmt::write!(f, "CLK_TOP_CAN0"),
                0xb2 => defmt::write!(f, "CLK_TOP_CAN1"),
                0xb3 => defmt::write!(f, "CLK_TOP_CAN2"),
                0xb4 => defmt::write!(f, "CLK_TOP_CAN3"),
                0xb5 => defmt::write!(f, "CLK_TOP_CAN4"),
                0xb6 => defmt::write!(f, "CLK_TOP_CAN5"),
                0xb7 => defmt::write!(f, "CLK_TOP_CAN6"),
                0xb8 => defmt::write!(f, "CLK_TOP_CAN7"),
                0xb9 => defmt::write!(f, "CLK_TOP_XPI0"),
                0xba => defmt::write!(f, "CLK_TOP_FEMC"),
                0xbb => defmt::write!(f, "CLK_TOP_ANA0"),
                0xbc => defmt::write!(f, "CLK_TOP_ANA1"),
                0xbd => defmt::write!(f, "CLK_TOP_ANA2"),
                0xbe => defmt::write!(f, "CLK_TOP_ANA3"),
                0xbf => defmt::write!(f, "CLK_TOP_AUD0"),
                0xc0 => defmt::write!(f, "CLK_TOP_AUD1"),
                0xc1 => defmt::write!(f, "CLK_TOP_ETH0"),
                0xc2 => defmt::write!(f, "CLK_TOP_PTP0"),
                0xc3 => defmt::write!(f, "CLK_TOP_REF0"),
                0xc4 => defmt::write!(f, "CLK_TOP_REF1"),
                0xc5 => defmt::write!(f, "CLK_TOP_NTMR0"),
                0xc6 => defmt::write!(f, "CLK_TOP_TSN1"),
                0xc7 => defmt::write!(f, "CLK_TOP_TSN2"),
                0xc8 => defmt::write!(f, "CLK_TOP_TSN3"),
