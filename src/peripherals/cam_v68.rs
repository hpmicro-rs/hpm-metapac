...
pub mod regs {
    ...
    impl ActSize {
        ...
        #[doc = "actual width after scale and/or roi."]
        #[inline(always)]
        pub const fn set_act_width(&mut self, val: u16) {
        ...
        #[doc = "actual height after scale and/or roi."]
        #[inline(always)]
        pub const fn set_act_height(&mut self, val: u16) {
    ...
    impl core::fmt::Debug for ActSize {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("ActSize")
                .field("act_width", &self.act_width())
    ...
    impl defmt::Format for ActSize {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "ActSize {{ act_width: {=u16:?}, act_height: {=u16:?} }}",
                self.act_width(),
                self.act_height()
            )
        }
    ...
    impl AlarmSet {
        ...
        #[doc = "define signal duty cycles(base clock) 0x0: disable signal 0x1: high 1, low 15 0x2: high 2, low 14 …... 0xF: high 15, low 1."]
        #[inline(always)]
        pub const fn set_fatal_normal(&mut self, val: u8) {
        ...
        #[doc = "define signal duty cycles(base clock) 0x0: disable signal 0x1: high 1, low 15 0x2: high 2, low 14 …... 0xF: high 15, low 1."]
        #[inline(always)]
        pub const fn set_sig_normal(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for AlarmSet {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("AlarmSet")
                .field("pre_div", &self.pre_div())
                .field("fatal_normal", &self.fatal_normal())
                .field("sig_normal", &self.sig_normal())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for AlarmSet {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "AlarmSet {{ pre_div: {=u16:?}, fatal_normal: {=u8:?}, sig_normal: {=u8:?} }}",
                self.pre_div(),
                self.fatal_normal(),
                self.sig_normal()
            )
...
configuration."]
        ...
        #[doc = "invert den pad input before it is used."]
        #[inline(always)]
        pub const fn set_inv_den(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr18 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Cr18 {{ awqos: {=u8:?} }}", self.awqos())
        }
    }
    #[doc = "Control 2 Register."]
    #[repr(transparent)]
    ...
    impl HsyncValidCnt {
        ...
        #[doc = "hsync valid counter."]
        #[inline(always)]
        pub const fn set_hsync_valid_cnt(&mut self, val: u32) {
    ...
    impl core::fmt::Debug for HsyncValidCnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("HsyncValidCnt")
                .field("hsync_valid_cnt", &self.hsync_valid_cnt())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for HsyncValidCnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "HsyncValidCnt {{ hsync_valid_cnt: {=u32:?} }}",
                self.hsync_valid_cnt()
            )
        }
    }
    #[doc = "Ideal Image Size Register."]
...
and cr1\\[store_mode\\]. Default value is 2*pixel number. As the input data from the sensor is 8-bit/pixel format, the IMAGE_WIDTH should be a multiple of 8 pixels."]
    ...
    impl ProCtrl {
        ...
        #[doc = "000 keep all pixel for width 001 keep 1 for every 2 pixel for width 010 keep 1 for every 3 pixel for width 011 keep 1 for every 4 pixel for width 100 keep 1 for every 5 pixel for width 101 keep 1 for every 6 pixel for width 110 keep 1 for every 7 pixel for width 111 keep 1 for every 8 pixel for width."]
        #[inline(always)]
        pub const fn set_scale_width_select(&mut self, val: u8) {
            self.0 = (self.0 & !(0x07 << 0usize)) | (((val as u32) & 0x07) << 0usize);
        }
        ...
        #[doc = "000 keep all pixel for height 001 keep 1 for every 2 pixel for height 010 keep 1 for every 3 pixel for height 011 keep 1 for every 4 pixel for height 100 keep 1 for every 5 pixel for height 101 keep 1 for every 6 pixel for height 110 keep 1 for every 7 pixel for height 111 keep 1 for every 8 pixel for height."]
        #[inline(always)]
        pub const fn set_scale_height_select(&mut self, val: u8) {
        ...
        #[doc = "scale configration update."]
        #[inline(always)]
        pub const fn set_scale_update(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        ...
        #[doc = "roi configration update."]
        #[inline(always)]
        pub const fn set_roi_update(&mut self, val: bool) {
        ...
        #[doc = "0 generate alarm in normal mode 1 force to generate fatal alarm."]
        #[inline(always)]
        pub const fn set_err_inject(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for ProCtrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("ProCtrl")
                .field("scale_width_select", &self.scale_width_select())
                .field("scale_height_select", &self.scale_height_select())
                .field("scale_update", &self.scale_update())
                .field("roi_update", &self.roi_update())
                .field("err_inject", &self.err_inject())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for ProCtrl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "ProCtrl {{ scale_width_select: {=u8:?}, scale_height_select: {=u8:?}, scale_update: {=bool:?}, roi_update: {=bool:?}, err_inject: {=bool:?} }}" , self . scale_width_select () , self . scale_height_select () , self . scale_update () , self . roi_update () , self . err_inject ())
        }
    }
    #[doc = "Roi Width Config Register."]
    #[repr(transparent)]
    ...
    impl RoiHeight {
        ...
        #[doc = "start address of height for roi."]
        #[inline(always)]
        pub const fn set_roi_height_start(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
        ...
        #[doc = "end address of height for roi."]
        #[inline(always)]
        pub const fn set_roi_height_end(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
    ...
    impl core::fmt::Debug for RoiHeight {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("RoiHeight")
                .field("roi_height_start", &self.roi_height_start())
                .field("roi_height_end", &self.roi_height_end())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for RoiHeight {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "RoiHeight {{ roi_height_start: {=u16:?}, roi_height_end: {=u16:?} }}",
                self.roi_height_start(),
                self.roi_height_end()
            )
        }
    }
    ...
    impl RoiWidth {
        ...
        #[doc = "start address of width for roi."]
        #[inline(always)]
        pub const fn set_roi_width_start(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
        ...
        #[doc = "end address of width for roi."]
        #[inline(always)]
        pub const fn set_roi_width_end(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
    ...
    impl core::fmt::Debug for RoiWidth {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("RoiWidth")
                .field("roi_width_start", &self.roi_width_start())
                .field("roi_width_end", &self.roi_width_end())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for RoiWidth {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "RoiWidth {{ roi_width_start: {=u16:?}, roi_width_end: {=u16:?} }}",
                self.roi_width_start(),
                self.roi_width_end()
            )
        }
    }
    ...
    impl ValidMargin {
        ...
        #[doc = "vsync valid margin."]
        #[inline(always)]
        pub const fn set_vsync_valid_margin(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
        ...
        #[doc = "hsync valid margin."]
        #[inline(always)]
        pub const fn set_hsync_valid_margin(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 16usize)) | (((val as u32) & 0xffff) << 16usize);
        }
    }
    ...
    impl core::fmt::Debug for ValidMargin {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("ValidMargin")
                .field("vsync_valid_margin", &self.vsync_valid_margin())
                .field("hsync_valid_margin", &self.hsync_valid_margin())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for ValidMargin {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "ValidMargin {{ vsync_valid_margin: {=u16:?}, hsync_valid_margin: {=u16:?} }}",
                self.vsync_valid_margin(),
                self.hsync_valid_margin()
            )
        }
    }
    #[doc = "vsync valid counter."]
    ...
    impl VsyncValidCnt {
        ...
        #[doc = "vsync valid counter."]
        #[inline(always)]
        pub const fn set_vsync_valid_cnt(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for VsyncValidCnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("VsyncValidCnt")
                .field("vsync_valid_cnt", &self.vsync_valid_cnt())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for VsyncValidCnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "VsyncValidCnt {{ vsync_valid_cnt: {=u32:?} }}",
                self.vsync_valid_cnt()
            )
        }
    }
}
