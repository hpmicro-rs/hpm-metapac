...
pub mod regs {
    ...
    impl Ciphiv {
        ...
        #[doc = "cipher initialization vector."]
        #[inline(always)]
        pub const fn set_ciphiv(&mut self, val: u32) {
    ...
    impl core::fmt::Debug for Ciphiv {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ciphiv")
                .field("ciphiv", &self.ciphiv())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ciphiv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ciphiv {{ ciphiv: {=u32:?} }}", self.ciphiv())
        }
    }
    #[doc = "Command Pointer."]
    #[repr(transparent)]
    ...
    impl Cmdptr {
        ...
        #[doc = "current command addresses the register points to the multiword descriptor that is to be executed (or is currently being executed)."]
        #[inline(always)]
        pub const fn set_cmdptr(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Cmdptr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Cmdptr")
                .field("cmdptr", &self.cmdptr())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Cmdptr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Cmdptr {{ cmdptr: {=u32:?} }}", self.cmdptr())
        }
    }
    #[doc = "no description available."]
    #[repr(transparent)]
...
here. If CRC mode enabled, this work store the CRC expected result if the check enabled, or store the final calcuated CRC result."]
        #[inline(always)]
        pub const fn set_haswrd(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Haswrd {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Haswrd")
                .field("haswrd", &self.haswrd())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Haswrd {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Haswrd {{ haswrd: {=u32:?} }}", self.haswrd())
        }
    }
    #[doc = "Key Address."]
    #[repr(transparent)]
    ...
    impl Keyaddr {
        ...
        #[doc = "Key subword pointer. The valid indices are 0-3. After each write to the key data register, this field increments; To write a key, the software must first write the desired key index/subword to this register."]
        #[inline(always)]
        pub const fn set_subwrd(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for Keyaddr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Keyaddr")
                .field("subwrd", &self.subwrd())
    ...
    impl Keydat {
        ...
        #[doc = "This register provides the write access to the key/key subword specified by the key index register. Writing this location updates the selected subword for the key located at the index specified by the key index register. The write also triggers the SUBWORD field of the KEY register to increment to the next higher word in the key."]
        #[inline(always)]
        pub const fn set_keydat(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Keydat {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Keydat")
                .field("keydat", &self.keydat())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Keydat {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Keydat {{ keydat: {=u32:?} }}", self.keydat())
        }
    }
    #[doc = "Mod control register."]
    #[repr(transparent)]
    ...
    impl Modctrl {
        ...
        #[doc = "Decide whether the SDP byteswaps the Key (big-endian data). When all bits are set, the data is assumed to be in the big-endian format."]
        #[inline(always)]
        pub const fn set_keyswp(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val as u32) & 0x03) << 0usize);
        }
        ...
        #[doc = "Decide whether the SDP byteswaps the output data (big-endian data); When all bits are set, the data is assumed to be in the big-endian format."]
        #[inline(always)]
        pub const fn set_doutswp(&mut self, val: u8) {
        ...
        #[doc = "Decide whether the SDP byteswaps the input data (big-endian data); When all bits are set, the data is assumed to be in the big-endian format."]
        #[inline(always)]
        pub const fn set_dinswp(&mut self, val: u8) {
        ...
        #[doc = "When hashing is enabled, this bit controls the input or output data of the AES engine is hashed. 0 INPUT HASH 1 OUTPUT HASH."]
        #[inline(always)]
        pub const fn set_hasout(&mut self, val: bool) {
        ...
        #[doc = "HASH Check Enable Bit. 1x1, HASH check need, hash result will compare with the HASHRSLT 0-7 registers; 1x0, HASH check is not enabled, HASHRSLT0-7 store the HASH result. For SHA1, will use HASHRSLT0-3 words, and HASH 256 will use HASH0-7 words."]
        #[inline(always)]
        pub const fn set_haschk(&mut self, val: bool) {
        ...
        #[doc = "HASH Algorithem selection. 0x0 SHA1 — 0x1 CRC32 — 0x2 SHA256 —."]
        #[inline(always)]
        pub const fn set_hasalg(&mut self, val: u8) {
        ...
        #[doc = "AES direction 1x1, AES Decryption 1x0, AES Encryption."]
        #[inline(always)]
        pub const fn set_aesdir(&mut self, val: bool) {
...
from OTP for AES128; not valid for AES256. Other values, reserved."]
        #[inline(always)]
        pub const fn set_aesks(&mut self, val: u8) {
        ...
        #[doc = "AES mode selection. 0x0 = ECB; 0x1 = CBC; Others, reserved."]
        #[inline(always)]
        pub const fn set_aesmod(&mut self, val: u8) {
        ...
        #[doc = "AES algorithem selection. 0x0 = AES 128; 0x1 = AES 256; 0x8 = SM4； Others, reserved."]
        #[inline(always)]
        pub const fn set_aesalg(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for Modctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Modctrl")
                .field("keyswp", &self.keyswp())
                .field("doutswp", &self.doutswp())
                .field("dinswp", &self.dinswp())
                .field("hasout", &self.hasout())
                .field("haschk", &self.haschk())
                .field("hasalg", &self.hasalg())
                .field("aesdir", &self.aesdir())
                .field("aesks", &self.aesks())
                .field("aesmod", &self.aesmod())
                .field("aesalg", &self.aesalg())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Modctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Modctrl {{ keyswp: {=u8:?}, doutswp: {=u8:?}, dinswp: {=u8:?}, hasout: {=bool:?}, haschk: {=bool:?}, hasalg: {=u8:?}, aesdir: {=bool:?}, aesks: {=u8:?}, aesmod: {=u8:?}, aesalg: {=u8:?} }}" , self . keyswp () , self . doutswp () , self . dinswp () , self . hasout () , self . haschk () , self . hasalg () , self . aesdir () , self . aesks () , self . aesmod () , self . aesalg ())
        }
    }
    #[doc = "Next Packet Address Pointer."]
    #[repr(transparent)]
    ...
    impl Npktptr {
        ...
        #[doc = "Next Packet Address Pointer."]
        #[inline(always)]
        pub const fn set_npktptr(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Npktptr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Npktptr")
                .field("npktptr", &self.npktptr())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Npktptr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Npktptr {{ npktptr: {=u32:?} }}", self.npktptr())
        }
    }
    #[doc = "Packet buffer size."]
    #[repr(transparent)]
    ...
    impl Pktbuf {
        ...
        #[doc = "No description available."]
        #[inline(always)]
        pub const fn set_pktbuf(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Pktbuf {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pktbuf")
                .field("pktbuf", &self.pktbuf())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pktbuf {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Pktbuf {{ pktbuf: {=u32:?} }}", self.pktbuf())
        }
    }
    #[doc = "packet counter registers."]
    #[repr(transparent)]
    ...
    impl Pktcnt {
        ...
        #[doc = "The value written to this field is added to the spacket count."]
        #[inline(always)]
        pub const fn set_cntincr(&mut self, val: u8) {
        ...
        #[doc = "This read-only field shows the current (instantaneous) value of the packet counter."]
        #[inline(always)]
        pub const fn set_cntval(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 16usize)) | (((val as u32) & 0xff) << 16usize);
        }
    }
    ...
    impl core::fmt::Debug for Pktcnt {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pktcnt")
                .field("cntincr", &self.cntincr())
                .field("cntval", &self.cntval())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pktcnt {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Pktcnt {{ cntincr: {=u8:?}, cntval: {=u8:?} }}",
                self.cntincr(),
                self.cntval()
            )
        }
    ...
    impl Pktctl {
        ...
        #[doc = "Reflects whether the channel must issue an interrupt upon the completion of the packet."]
        #[inline(always)]
        pub const fn set_pktint(&mut self, val: bool) {
        ...
        #[doc = "whether the channel's semaphore must be decremented at the end of the current operation. When the semaphore reaches a value of zero, no more operations are issued from the channel."]
        #[inline(always)]
        pub const fn set_dcrsema(&mut self, val: bool) {
        ...
        #[doc = "Hash Initialization packat."]
        #[inline(always)]
        pub const fn set_hasini(&mut self, val: bool) {
        ...
        #[doc = "Hash Termination packet."]
        #[inline(always)]
        pub const fn set_hasfnl(&mut self, val: bool) {
        ...
        #[doc = "Load Initial Vector for the AES in this packet."]
        #[inline(always)]
        pub const fn set_ciphiv(&mut self, val: bool) {
        ...
        #[doc = "packet tag."]
        #[inline(always)]
        pub const fn set_pkttag(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for Pktctl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pktctl")
                .field("pktint", &self.pktint())
                .field("dcrsema", &self.dcrsema())
                .field("chain", &self.chain())
                .field("hasini", &self.hasini())
                .field("hasfnl", &self.hasfnl())
                .field("ciphiv", &self.ciphiv())
                .field("pkttag", &self.pkttag())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pktctl {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Pktctl {{ pktint: {=bool:?}, dcrsema: {=bool:?}, chain: {=bool:?}, hasini: {=bool:?}, hasfnl: {=bool:?}, ciphiv: {=bool:?}, pkttag: {=u8:?} }}" , self . pktint () , self . dcrsema () , self . chain () , self . hasini () , self . hasfnl () , self . ciphiv () , self . pkttag ())
        }
    }
    #[doc = "Packet Memory Destination Address."]
    #[repr(transparent)]
    ...
    impl Pktdst {
        ...
        #[doc = "Packet Memory Destination Address."]
        #[inline(always)]
        pub const fn set_pktdst(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Pktdst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pktdst")
                .field("pktdst", &self.pktdst())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pktdst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Pktdst {{ pktdst: {=u32:?} }}", self.pktdst())
        }
    }
    #[doc = "Packet Memory Source Address."]
    #[repr(transparent)]
    ...
    impl Pktsrc {
        ...
        #[doc = "Packet Memory Source Address."]
        #[inline(always)]
        pub const fn set_pktsrc(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Pktsrc {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pktsrc")
                .field("pktsrc", &self.pktsrc())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pktsrc {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Pktsrc {{ pktsrc: {=u32:?} }}", self.pktsrc())
        }
    }
    #[doc = "SDP control register."]
    #[repr(transparent)]
    ...
    impl Sdpcr {
        ...
        #[doc = "when set to \"1\", the 1st data packet descriptor loacted in the register(CMDPTR, NPKTPTR, ...) when set to \"0\", the 1st data packet descriptor loacted in the memeory(pointed by CMDPTR)."]
        #[inline(always)]
        pub const fn set_rdscen(&mut self, val: bool) {
        ...
        #[doc = "Test purpose for interrupt when Packet counter reachs \"0\", but CHAIN=1 in the current packet."]
        #[inline(always)]
        pub const fn set_tstpkt0irq(&mut self, val: bool) {
        ...
        #[doc = "Decryption Disable bit, Write to 1 to disable the decryption."]
        #[inline(always)]
        pub const fn set_dcrpdi(&mut self, val: bool) {
        ...
        #[doc = "Constant Fill to memory, controlled by SW. 1, Constant fill is Enabled. 0, Constant fill is Disabled."]
        #[inline(always)]
        pub const fn set_confen(&mut self, val: bool) {
        ...
        #[doc = "Memory Copy Enablement, controlled by SW. 1, Memory copy is Enabled. 0, Memory copy is Disabled."]
        #[inline(always)]
        pub const fn set_mcpen(&mut self, val: bool) {
        ...
        #[doc = "Cipher Enablement, controlled by SW. 1, Cipher is Enabled. 0, Cipher is Disabled."]
        #[inline(always)]
        pub const fn set_ciphen(&mut self, val: bool) {
        ...
        #[doc = "HASH Disable, read the info, whether the HASH features is besing disable in this chip or not. 1, HASH is disabled in this chip. 0, HASH is enabled in this chip."]
        #[inline(always)]
        pub const fn set_hasdis(&mut self, val: bool) {
        ...
        #[doc = "Cipher Disable, read the info, whether the CIPHER features is besing disable in this chip or not. 1, Cipher is disabled in this chip. 0, Cipher is enabled in this chip."]
        #[inline(always)]
        pub const fn set_cipdis(&mut self, val: bool) {
        ...
        #[doc = "Clock Gate for the SDP main logic. Write to 1 will clock gate for most logic of the SDP block, dynamic power saving when not use SDP block."]
        #[inline(always)]
        pub const fn set_clkgat(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Sdpcr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Sdpcr")
                .field("inten", &self.inten())
                .field("rdscen", &self.rdscen())
                .field("tstpkt0irq", &self.tstpkt0irq())
                .field("dcrpdi", &self.dcrpdi())
                .field("confen", &self.confen())
                .field("mcpen", &self.mcpen())
                .field("hashen", &self.hashen())
                .field("ciphen", &self.ciphen())
                .field("hasdis", &self.hasdis())
                .field("cipdis", &self.cipdis())
                .field("clkgat", &self.clkgat())
                .field("sftrst", &self.sftrst())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Sdpcr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Sdpcr {{ inten: {=bool:?}, rdscen: {=bool:?}, tstpkt0irq: {=bool:?}, dcrpdi: {=bool:?}, confen: {=bool:?}, mcpen: {=bool:?}, hashen: {=bool:?}, ciphen: {=bool:?}, hasdis: {=bool:?}, cipdis: {=bool:?}, clkgat: {=bool:?}, sftrst: {=bool:?} }}" , self . inten () , self . rdscen () , self . tstpkt0irq () , self . dcrpdi () , self . confen () , self . mcpen () , self . hashen () , self . ciphen () , self . hasdis () , self . cipdis () , self . clkgat () , self . sftrst ())
        }
    }
    #[doc = "Status Registers."]
    #[repr(transparent)]
    ...
    impl Sta {
        ...
        #[doc = "buffer chain error happen when packet's CHAIN bit=0, but the Packet counter is still not zero."]
        #[inline(always)]
        pub const fn set_errchain(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "Hashing Check Error."]
        #[inline(always)]
        pub const fn set_errhas(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ...
        #[doc = "Destination Buffer Error."]
        #[inline(always)]
        pub const fn set_errdst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "Source Buffer Access Error."]
        #[inline(always)]
        pub const fn set_errsrc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "Packet head access error, or status update error."]
        #[inline(always)]
        pub const fn set_errpkt(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        ...
        #[doc = "Working mode setup error."]
        #[inline(always)]
        pub const fn set_errset(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        ...
        #[doc = "Packet processing done, will trigger this itnerrrupt when the \"PKTINT\" bit set in the packet control word."]
        #[inline(always)]
        pub const fn set_pktdon(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        ...
        #[doc = "Packet Counter registers reachs to ZERO now."]
        #[inline(always)]
        pub const fn set_pktcnt0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "Hashing Busy."]
        #[must_use]
        ...
        #[doc = "Hashing Busy."]
        #[inline(always)]
        pub const fn set_hasbsy(&mut self, val: bool) {
        ...
        #[doc = "AES Busy."]
        #[inline(always)]
        pub const fn set_aesbsy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize);
        }
        ...
        #[doc = "the chain buffer \"chain\" bit is \"1\", while packet counter is \"0\", now, waiting for new buffer data."]
        #[inline(always)]
        pub const fn set_chn1pkt0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
    ...
    impl core::fmt::Debug for Sta {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Sta")
                .field("errchain", &self.errchain())
                .field("errhas", &self.errhas())
                .field("errdst", &self.errdst())
                .field("errsrc", &self.errsrc())
                .field("errpkt", &self.errpkt())
                .field("errset", &self.errset())
                .field("pktdon", &self.pktdon())
                .field("pktcnt0", &self.pktcnt0())
                .field("hasbsy", &self.hasbsy())
                .field("aesbsy", &self.aesbsy())
                .field("chn1pkt0", &self.chn1pkt0())
                .field("irq", &self.irq())
                .field("tag", &self.tag())
                .finish()
        }
    ...
    impl defmt::Format for Sta {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Sta {{ errchain: {=bool:?}, errhas: {=bool:?}, errdst: {=bool:?}, errsrc: {=bool:?}, errpkt: {=bool:?}, errset: {=bool:?}, pktdon: {=bool:?}, pktcnt0: {=bool:?}, hasbsy: {=bool:?}, aesbsy: {=bool:?}, chn1pkt0: {=bool:?}, irq: {=bool:?}, tag: {=u8:?} }}" , self . errchain () , self . errhas () , self . errdst () , self . errsrc () , self . errpkt () , self . errset () , self . pktdon () , self . pktcnt0 () , self . hasbsy () , self . aesbsy () , self . chn1pkt0 () , self . irq () , self . tag ())
        }
    }
}
