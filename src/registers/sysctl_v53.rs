        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "mux",
                    description: Some(
                        "current mux 0: ahb0 clock N 1: ana clock.",
                    ),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mux",
                    description: Some(
                        "current mux in clock component 0:osc0_clk0 1:pll0_clk0 2:pll0_clk1 3:pll0_clk2 4:pll1_clk0 5:pll1_clk1 6:pll1_clk2 7:pll1_clk3.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wait",
                    description: Some(
                        "wait time for memory retention mode transition, default value is 15 0: 0 clock cycle 1: 1 clock cycles . . . clock cycles count on 24MHz.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mem_ret_p",
                    description: Some(
                        "memory info retention control signal 0: memory not enterexitretention mode 1: memory enter retention mode.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "mem_ret_n",
                    description: Some(
                        "memory info retention control signal 0: memory enter retention mode 1: memory exit retention mode.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "PLL0CLK0",
                    description: Some(
                        "Dfaults to 720MHz. Default clock source for CPU0",
                    ),
                    value: 1,
                },
                EnumVariant {
