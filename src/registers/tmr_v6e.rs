        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "monitor_sel",
                    description: Some(
                        "set to monitor input signal high level time(chan_meas_high) clr to monitor input signal period(chan_meas_prd).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "opmode",
                    description: Some(
                        "0: round mode 1: one-shot mode, timer will stopped at reload point. NOTE: reload irq will be always set at one-shot mode at end.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
                ...
                Field {
                    name: "cnt_mode",
                    description: Some(
                        "0: internal counting mode, timer increase each gptmr clock cycle. 1: external counting mode, timer increase at each input signal posedge, reload/compare feature can still work but change at input signal posedge.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 18,
