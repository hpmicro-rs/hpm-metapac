        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "selrange_ldo",
                    description: Some(
                        "Defines the range for the LDO reference (vdd_soc) selrange_ldo = 0: LDO reference dvdd or vref_ldo in range [0.81;0.99] selrange_ldo = 1: LDO reference dvdd or vref_ldo in range [0.99;1.21].",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 11,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "selres",
                    description: Some(
                        "11-12bit 10-10bit 01-8bit 00-6bit.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    description: Some(
                        "convert clock numbers, set to 13 (0xD) for 12bit mode, which means convert need 14 adc clock cycles(based on clock after divider); set to 11 for 10bit mode; set to 9 for 8bit mode; set to 7 or 6bit mode; Ex: use 200MHz bus clock for adc, set sample_clock_number to 4, sample_clock_number_shift to 0, covert_clk_number to 13 for 12bit mode, clock_divder to 2, then each ADC conversion(plus sample) need 18(14 convert, 4 sample) cycles(66MHz).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
