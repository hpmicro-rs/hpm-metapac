        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "calon",
                    description: Some(
                        "calibration status. will be set by hardware after setting cal_start. cleared after calibration finished.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "cal_start",
                    description: Some(
                        "calibration start. software setting this bit to start calibration process. each bit for one channel.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "hr_update_mode",
                    description: Some(
                        "0: update the hr value for the first edge at reload point; 1: update the hr value for the first edge at the last edge; all others will be updated at previous edge for pair mode, only pwm_cfg 0/2/4/6 are used.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 29,
