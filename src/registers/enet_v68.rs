        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    ...
                    description: Some(
                        "RMII mode output clock pad select set to use txck as RMII refclk; clr to use rxck as RMII refclk; default 0(rxck) refclk is always from pad, can use external clock from pad, or use internal clock output to pad then loopback.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
                ...
                Field {
                    name: "enet0_phy_inf_sel",
                    description: Some(
                        "PHY mode select 000MII; 001RGMII; 100RMII; should be set before config IOMUX, otherwise may cause glitch for RGMII.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    ...
                    description: Some(
                        "set to enable output 50MHz clock to rmii phy. User should set it if use soc internal clock as refclk.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 19,
