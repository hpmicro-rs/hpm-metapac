        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cfg_rxd",
                    description: Some(
                        "data received 0: high 1: low 2: rise 3: fall.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rewind_sel",
                    description: Some(
                        "select one LATCH to rewind CMD register 0:LATCH[0] 1:LATCH[1] 2:LATCH[2] 3:LATCH[3].",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
