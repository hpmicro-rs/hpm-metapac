        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "swap_ctl",
                    description: Some(
                        "00 ：use swap table(if swap table all 0, then act nothing) 01 : byte swap 10 : 16bit swap 11 : 32bit swap.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "table",
                    description: Some(
                        "\"4bit for one byte, define how to swap, default is no swap. For HDMA, support up to 4-byte, the register default value is 0x3210\".",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
