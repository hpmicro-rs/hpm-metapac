        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "std",
                    description: Some(
                        "I2S standard selection 00: I2S Philips standard. 01: MSB justified standard (left justified) 10: LSB justified standard (right justified) 11: PCM standard For more details on I2S standards. Note: For correct operation, these bits should be configured when the I2S is disabled.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
