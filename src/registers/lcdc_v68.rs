        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    ...
                    description: Some(
                        "min HCNT value for CAMSYNC mode.",
                    ),
                    array: None,
                    byte_offset: 0x30,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    ...
                    description: Some(
                        "best HCNT value for CAMSYNC mode.",
                    ),
                    array: None,
                    byte_offset: 0x34,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    ...
                    description: Some(
                        "max HCNT value for CAMSYNC mode.",
                    ),
                    array: None,
                    byte_offset: 0x38,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    ...
                    description: Some(
                        "current HCNT value for CAMSYNC mode.",
                    ),
                    array: None,
                    byte_offset: 0x3c,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "str_high",
                    description: Some(
                        "1'b1: Store 8+ CLUT tables through APB 1'b0: Store 0-7 CLUT tables through APB.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "r_le_mode",
                    description: Some(
                        "Endianness mode for Red Color Pads 1: Little endian. Pad 0 --> Color LSB 0 0: Big Endian. Pad 0--> Color MSB 7.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
                ...
                Field {
                    name: "g_le_mode",
                    description: Some(
                        "Endianness mode for Green Color Pads 1: Little endian. Pad 0 --> Color LSB 0 0: Big Endian. Pad 0--> Color MSB 7.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "b_le_mode",
                    description: Some(
                        "Endianness mode for Blue Color Pads 1: Little endian. Pad 0 --> Color LSB 0 0: Big Endian. Pad 0--> Color MSB 7.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "shadow_op",
                    description: Some(
                        "Shadow Option 1: Use physical VSYNC (ST[VS_BLANK]) as shadow time. 0: Use layer internal logic VSYNC as shadow time. In general, this type of shadow control will have longer memory read time, so less underflow risk.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ab_mode",
                    description: Some(
                        "Alpha Blending Mode 0: SKBlendMode_Clear; 3: SKBlendMode_SrcOver 14: SRC org 15: DST org Others: Reserved.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    ...
                    description: Some(
                        "1: handshake buffer is 16 rows hight per ping or pang buf. 0: handshake buffer is 8 rows hight per ping or pang buf.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 21,
                ...
                Field {
                    ...
                    description: Some(
                        "Resample the input data stream in the horizontal direction 0: don't resample positive n: upsample-by-n+1 (2 to 8) negtive n: downsample-by-n+1 (2 to 8).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
                ...
                Field {
                    ...
                    description: Some(
                        "Resample the input data stream in the verticle direction 0: don't resample positive n: upsample-by-n+1 (2 to 8) negtive n: downsample-by-n+1 (2 to 8).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
