        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    description: Some(
                        "disable power loss protection 0: power loss protection enabled, DCDC shuts down when power loss 1: power loss protection disabled, DCDC try working after power voltage drop.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "stby_volt",
                    description: Some(
                        "DCDCM voltage in mV in standby mode, , value valid through 600-1375, , step 25mV. Hardware select voltage no less than target if not on valid steps, with maximum 1375mV. 600: 600mV 625: 625mV . . . 1375:1375mV.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "clk_sel",
                    description: Some(
                        "clock selection 0: select DCDCM internal oscillator 1: select RC24M oscillator.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "volt",
                    description: Some(
                        "DCDCM voltage in mV in normal mode, value valid through 600-1375, , step 25mV. Hardware select voltage no less than target if not on valid steps, with maximum 1375mV. 600: 600mV 625: 625mV . . . 1375:1375mV.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "mode",
                    description: Some(
                        "DCDCM work mode XX0: turn off 001: basic mode 011: generic mode 101: automatic mode 111: expert mode.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "ready",
                    description: Some(
                        "Ready flag 0: DCDCM is applying new change 1: DCDCM is ready.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "retention",
                    description: Some(
                        "DCDCM enter standby mode, which will reduce voltage for memory content retention 0: Shutdown DCDCM 1: reduce DCDC voltage.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "disable_short",
                    description: Some(
                        "disable output short circuit protection 0: short circuits protection enabled, DCDCM shut down if short circuit on output detected 1: short circuit protection disabled.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
                ...
                Field {
                    name: "disable_overvoltage",
                    description: Some(
                        "output over voltage protection 0: protection enabled, DCDCM will shut down is output voltage is unexpected high 1: protection disabled, DCDCM continue to adjust output voltage.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "disable_power_loss",
                    description: Some(
                        "disable power loss protection 0: power loss protection enabled, DCDCM shuts down when power loss 1: power loss protection disabled, DCDCM try working after power voltage drop.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "scg",
                    description: Some(
                        "control whether clock being gated during PMIC low power flow, 2 bits for each peripheral 00,01: reserved 10: clock is always off 11: clock is always on bit6-7:gpio bit8-9:ioc bit10-11: timer bit12-13:wdog bit14-15:uart bit16-17:VAD bit18-19:SRAM.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
