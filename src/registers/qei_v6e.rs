        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "low_limit",
                    description: Some(
                        "for SINCOS mode, if (max+min/2) of the two adc result, is small than limit, then this value is treated as unvalid, no position output. this is uesd to avoid wrong adc resule(such as 0 or same sin cos value).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "timestamp",
                    description: Some(
                        "for SIN/COS mode, it saves the timestampe of the begining of first ADC sample time; for ABZ mode, it saves the timestampe of edge of input signals.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
