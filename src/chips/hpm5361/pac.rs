...
pub mod trgmmux {
    ...
    pub const TRGM0_OUTPUT_SRC_CMP1_WIN: usize = 29;
    ...
    pub const TRGM0_INPUT_SRC_CMP1_OUT: usize = 7;
    pub const TRGM0_OUTPUT_SRC_CMP0_WIN: usize = 28;
    ...
    pub const TRGM0_INPUT_SRC_CMP0_OUT: usize = 6;
